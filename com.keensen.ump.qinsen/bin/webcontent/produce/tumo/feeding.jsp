...
<js:load scriptPath="qinsen/produce/tumo/js/feedingUi.js"/>
<js:load scriptPath="qinsen/produce/tumo/js/feedingEv.js"/>
...
<script type="text/javascript">
  ...
  FunctionMgr.load({ 
			mainfn:com.keensen.ump.qinsen.produce.FeedingMgr
		});
 </script>
</head>
<body>
<div id="feedingmgr"></div>
</body>
</html>