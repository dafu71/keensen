...
<%
	com.eos.data.datacontext.IUserObject userObject = (com.eos.data.datacontext.IUserObject) request.getSession().getAttribute(com.eos.data.datacontext.IUserObject.KEY_IN_CONTEXT);
  	...
  	rootUrl = rootUrl.replace("/qinsen/produce/pack/logo/index.jsp","");
...
<js:load scriptPath="qinsen/produce/pack/logo/js/manageUi.js"/>
<js:load scriptPath="qinsen/produce/pack/logo/js/manageEv.js"/>
...
<script type="text/javascript">
  ...
  var teamId = '';
  <% } %>
  var listid = 'produce-marklogomgr-list';
  FunctionMgr.load({ 
			mainfn:com.keensen.ump.qinsen.produce.marklogoMgr
		});
 </script>
</head>
<body>
<div id="marklogomgr"></div>
