...
<%
	com.eos.data.datacontext.IUserObject userObject = (com.eos.data.datacontext.IUserObject) request.getSession().getAttribute(com.eos.data.datacontext.IUserObject.KEY_IN_CONTEXT);
  	...
  	rootUrl = rootUrl.replace("/qinsen/produce/pack/records/index.jsp","");
...
<js:load scriptPath="qinsen/produce/pack/records/js/manageUi.js"/>
<js:load scriptPath="qinsen/produce/pack/records/js/manageEv.js"/>
...
<script type="text/javascript">
  ...
  var teamId = '';
  <% } %>
  var listid = 'produce-printrecordsmgr-list';
  FunctionMgr.load({ 
			mainfn:com.keensen.ump.qinsen.produce.printrecordsMgr
		});
 </script>
</head>
<body>
<div id="printrecordsmgr"></div>
