com.keensen.ump.qinsen.produce.tumoMgr = function() {
			...
			items : [{
				...
				fields : [{
							...
							listeners : {
								scope : this,
								'expand' : function(A) {
									this.inputWindow.isReplaceTrough.reset();
								},
								'select' : function(combo, record, index) {
									if (index == 0) {
										Ext.Msg.alert("系统提示", "您已选择更换漂洗槽！");
									}
								}
	...
	this.initFeedingWindow = function() {
		var _this = this;
		...
		this.feedingWindow = this.feedingWindow || new Ext.Window({
					title : '涂膜生产加料记录',
					resizable : true,
					minimizable : false,
					maximizable : true,
		...
		this.queryPanel4ChooseDefect = this.queryPanel4ChooseDefect
				|| new Ext.fn.QueryPanel({
							...
							fields : [{
								...
								listeners : {
									"expand" : function(A) {
										_this.queryPanel4ChooseDefect.first
												.reset()
									}
								}
							}, {
	...
	this.initAddDefectWindow = function() {
		...
		this.addDefectWindow = this.addDefectWindow || new Ext.fn.FormWindow({
			...
			items : [{
				...
				pgrid : this.listPanel,
				columns : 12,
				saveUrl : 'com.keensen.ump.produce.quality.defect.saveTmDefectList.biz.ext',
				fields : [{
							xtype : 'trigger',
							dataIndex : 'defectName',
							ref : '../../defectName',
	...
	this.initColorbWindow = function() {

		var _this = this;
		this.colorbWindow = this.colorbWindow || new Ext.fn.FormWindow({
			title : '色差b*值录入',
			height : 300,
			width : 400,
			resizable : false,
			...
			items : [{
						...
						columns : 2,
						loadUrl : 'com.keensen.ump.qinsen.tumo.expandTumo.biz.ext',
						saveUrl : 'com.keensen.ump.qinsen.tumo.saveColorb.biz.ext',
						fields : [{
									xtype : 'numberfield',
									dataIndex : 'colorb',
									ref : '../../colorb',
