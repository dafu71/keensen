...
com.zoomlion.hjsrm.cpflpzcxdl.CpflpzcxzlMgr.prototype.initEvent = function() {
	...
	this.listPanel.mon(this.listPanel,'delete', function(gird,records){
		...
		Ext.Ajax.request({
			method : "post",
			url :'com.zoomlion.hjsrm.supply.manager.supply.cpflqdMgr.delcpflpzcxzl.biz.ext',
			jsonData : {
				entitys:vals
			},
...
com.zoomlion.hjsrm.cpflpzcxdl.CpflpzcxzlMgr.prototype.onAdd = function() {
 	var sjid = this.listPanel.sjid;
 	var sjdm = this.listPanel.sjdm;
 	if(!sjid){
 		Ext.Msg.alert('系统提示','请先选择一个有效的产品大类!');
 		return;
 	}
...
com.zoomlion.hjsrm.cpflpzcxdl.CpflpzcxzlMgr.prototype.onDel = function() {
...
com.zoomlion.hjsrm.cpflpzcxdl.CpflpzcxzlMgr.prototype.onSave = function() {
