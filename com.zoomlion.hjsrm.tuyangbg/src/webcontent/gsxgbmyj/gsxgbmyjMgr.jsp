...
<js:load scriptPath="tuyangbg/gsxgbmyj/js/gsxgbmyjUi.js"/>
<js:load scriptPath="tuyangbg/gsxgbmyj/js/gsxgbmyjEv.js"/>
...
<script type="text/javascript">
   ...
   FunctionMgr.load({ 
			mainfn:com.zoomlion.hjsrm.tuyangbg.GsxgbmyjMgr
		});

 </script>
</head>
<body>
<div id="gsxgbmyjMgr"></div>
</body>
</html>