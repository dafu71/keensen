 ...
 * 销毁组件
 */
com.zoomlion.hjsrm.tuyangbg.Supplier1Mgr.prototype.destroy = function() {
 ...
 * 初始化组件事件
 */
com.zoomlion.hjsrm.tuyangbg.Supplier1Mgr.prototype.initEvent = function() {

	var attachmentParams = {
		relationId : processinstid,
		groupId : 'tybgfile'
	};
	Ext.getCmp(this.gattachId).setPostParams(attachmentParams);
	Ext.getCmp(this.gattachId).loadParams = attachmentParams;
	Ext.getCmp(this.gattachId).loadAttachmentRemote();
 ...
 * 选择人员信息
 */
com.zoomlion.hjsrm.tuyangbg.Supplier1Mgr.prototype.onSelect = function() {
 ...
 * 移除操作员方法
 */
com.zoomlion.hjsrm.tuyangbg.Supplier1Mgr.prototype.onDelOperator = function() {
 ...
 * @return {Boolean}
 */
com.zoomlion.hjsrm.tuyangbg.Supplier1Mgr.prototype.onSave = function() {
 ...
 * 回退窗口关闭
 */
com.zoomlion.hjsrm.tuyangbg.Supplier1Mgr.prototype.onBackClose= function() {
 ...
 * 回退窗口，选择需要回退的环节
 */
com.zoomlion.hjsrm.tuyangbg.Supplier1Mgr.prototype.onBackItem = function() {	
 ...
 * 回退窗口提交
 */
com.zoomlion.hjsrm.tuyangbg.Supplier1Mgr.prototype.onBack= function() {
	var _this=this;
 ...
 * 流程处理TAB页关闭
 */
com.zoomlion.hjsrm.tuyangbg.Supplier1Mgr.prototype.onClose = function() {
	closeMyTab();
}
