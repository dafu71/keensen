com.zoomlion.hjsrm.tuyangbg.SjzxclMgr.prototype.destroy = function() {
...
com.zoomlion.hjsrm.tuyangbg.SjzxclMgr.prototype.initEvent = function() {
	...
	Ext.getCmp(this.battachId).setPostParams(attachmentParams);
	Ext.getCmp(this.battachId).loadParams = attachmentParams;
	Ext.getCmp(this.battachId).loadAttachmentRemote();
	...
	this.storePerson.baseParams = {"roleid" : "421"};									
 ...
 * 选择人员信息
 */
/*com.zoomlion.hjsrm.techNotice.AuditingMgr.prototype.onSelect = function() {
 ...
 * 移除角色操作员方法
 */
com.zoomlion.hjsrm.tuyangbg.SjzxclMgr.prototype.onDelOperator = function() {
...
com.zoomlion.hjsrm.tuyangbg.SjzxclMgr.prototype.onSave = function() {
	...
	var mk = new Ext.LoadMask(_this.editPanel.id, {
				msg : '正在保存，请稍候!',
				removeMask : true
			});
	mk.show();
	...
	Ext.Ajax.request({
				method : "post",
				scope : this,
				url : 'com.zoomlion.hjsrm.tuyangbg.tuyangbg.ywbmqrTybgNotice.biz.ext',
				jsonData : {
					persons : vals,
					tybgNotices:forms					
				},
 ...
 * 回退窗口关闭
 */
com.zoomlion.hjsrm.tuyangbg.SjzxclMgr.prototype.onBackClose= function() {
 ...
 * 回退窗口，选择需要回退的环节
 */
com.zoomlion.hjsrm.tuyangbg.SjzxclMgr.prototype.onBackItem = function() {	
 ...
 * 回退窗口提交
 */
com.zoomlion.hjsrm.tuyangbg.SjzxclMgr.prototype.onBack= function() {
	var _this=this;
...
com.zoomlion.hjsrm.tuyangbg.SjzxclMgr.prototype.onClose = function() {
	closeMyTab();
}
