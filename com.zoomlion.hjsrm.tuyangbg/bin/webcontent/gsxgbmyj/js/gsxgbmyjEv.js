com.zoomlion.hjsrm.tuyangbg.GsxgbmyjMgr.prototype.destroy = function() {
...
com.zoomlion.hjsrm.tuyangbg.GsxgbmyjMgr.prototype.initEvent = function() {
	
	var attachmentParams = {
		relationId : processinstid,
		groupId : 'tybgfile'
	};
	Ext.getCmp(this.aattachId).setPostParams(attachmentParams);
	Ext.getCmp(this.aattachId).loadParams = attachmentParams;
	Ext.getCmp(this.aattachId).loadAttachmentRemote();
 ...
 * 选择人员信息
 */
/*com.zoomlion.hjsrm.techNotice.CollateFlowMgr.prototype.onSelect = function() {
 ...
 * 回退窗口，选择需要回退的环节
 */
com.zoomlion.hjsrm.tuyangbg.GsxgbmyjMgr.prototype.onBackItem = function() {	
 ...
 * 移除角色操作员方法
 */
com.zoomlion.hjsrm.tuyangbg.GsxgbmyjMgr.prototype.onDelOperator = function() {
 ...
 * @return {Boolean}
 */
com.zoomlion.hjsrm.tuyangbg.GsxgbmyjMgr.prototype.onSave = function() {
    ...
    if(records.length==1){
    	...
    	var selOperaotorids =this.listEmpPanel.getSelectionModel().getSelections();
		if (selOperaotorids.length > 0) {		
				var vals = [];
				Ext.each(selOperaotorids, function(record) {
							vals[vals.length] = {						
...
com.zoomlion.hjsrm.tuyangbg.GsxgbmyjMgr.prototype.onClose = function() {
	closeMyTab();
}
 ...
 * 回退窗口关闭
 */
com.zoomlion.hjsrm.tuyangbg.GsxgbmyjMgr.prototype.onBackClose= function() {
 ...
 * 回退窗口提交
 */
com.zoomlion.hjsrm.tuyangbg.GsxgbmyjMgr.prototype.onBack= function() {
	var _this=this;
