...
<js:load scriptPath="tuyangbg/ywbmqr/js/ywbmqrUi.js"/>
<js:load scriptPath="tuyangbg/ywbmqr/js/ywbmqrEv.js"/>
...
<script type="text/javascript">
   ...
   FunctionMgr.load({ 
			mainfn:com.zoomlion.hjsrm.tuyangbg.YwbmqrMgr
		});

 </script>
</head>
<body>
<div id="ywbmqrMgr"></div>
</body>
</html>