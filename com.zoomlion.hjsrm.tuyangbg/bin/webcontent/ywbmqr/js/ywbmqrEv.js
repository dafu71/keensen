com.zoomlion.hjsrm.tuyangbg.YwbmqrMgr.prototype.destroy = function() {
...
com.zoomlion.hjsrm.tuyangbg.YwbmqrMgr.prototype.initEvent = function() {

	var attachmentParams = {
		relationId : processinstid,
		groupId : 'tybgfile'
	};
	Ext.getCmp(this.tattachId).setPostParams(attachmentParams);
	Ext.getCmp(this.tattachId).loadParams = attachmentParams;
	Ext.getCmp(this.tattachId).loadAttachmentRemote();
 ...
 * 选择人员信息
 */
/*com.zoomlion.hjsrm.techNotice.ConfirmMgr.prototype.onSelect = function() {
 ...
 * 移除角色操作员方法
 */
com.zoomlion.hjsrm.tuyangbg.YwbmqrMgr.prototype.onDelOperator = function() {
...
com.zoomlion.hjsrm.tuyangbg.YwbmqrMgr.prototype.onSave = function() {
 ...
 * 回退窗口关闭
 */
com.zoomlion.hjsrm.tuyangbg.YwbmqrMgr.prototype.onBackClose= function() {
 ...
 * 回退窗口，选择需要回退的环节
 */
com.zoomlion.hjsrm.tuyangbg.YwbmqrMgr.prototype.onBackItem = function() {	
 ...
 * 回退窗口提交
 */
com.zoomlion.hjsrm.tuyangbg.YwbmqrMgr.prototype.onBack= function() {
	var _this=this;
...
com.zoomlion.hjsrm.tuyangbg.YwbmqrMgr.prototype.onClose = function() {
	closeMyTab();
}
