com.zoomlion.hjsrm.srmclient.finishedMgr = function() {
	...
	this.initQueryPanel = function() {
		this.queryPanel = new Ext.fn.QueryPanel({
					...
					fields : [{
								...
								xtype : "dateregion",
								width : 200,
								nameArray : ['condition/endtime_min',
										'condition/endtime_max'],
								fieldLabel : "完成时间",
								format : "Y-m-d"
							}]
				});
	...
	this.initListPanel = function() {
		...
		this.listPanel = new Ext.fn.ListPanel({
			...
			columns : [new Ext.grid.RowNumberer(), selModel, {
						...
						renderer : function(v, m, r, i) {
							...
							return "<a style='" + fontcolor
									+ "' href='javascript:showDetail(" + Ext.encode(listId)
									+ ","
									+ i
									+ ");'>" + v + "</a>";
						...
						scope : this,
						renderer : function(v, m, r, i) {
							return "<img alt='流程图' src='srmclient/finished/img/color_wheel.png' onclick='showProcessGraph("
									+ Ext.encode(listId)
									+ ","
									+ i
						...
						renderer : function(v, m, r, i) {
							...
							return "<img alt='流程日志' src='srmclient/finished/img/chart_organisation.png' onclick='showHistory("
									+ Ext.encode(listId)
									+ ","
									+ i
									+ ")'; style='cursor:pointer'>";
						...
						scope : this,
						renderer : function(v, m, r, i) {
							var esheetno = r.get('esheetno');
							var str = "<a href='javascript:sendread("
									+ Ext.encode(listId) + "," + i + ");'>"
									+ "转阅</a>";
							return str;
						}
			...
			store : new Ext.data.JsonStore({
				url : 'com.zoomlion.hjsrm.srmclient.WorkflowClient.queryFinished.biz.ext',
				root : 'data',
				idProperty:'',
				autoLoad : true,
