 ...
 * <ul>
 *   <li>{@link com.zoomlion.hjsrm.pub.sap.SapSrmPurchase.impl.GenlPurchaseEkpoImpl#getEbeln <em>Ebeln</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.sap.SapSrmPurchase.impl.GenlPurchaseEkpoImpl#getEbelp <em>Ebelp</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.sap.SapSrmPurchase.impl.GenlPurchaseEkpoImpl#getLoekz <em>Loekz</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.sap.SapSrmPurchase.impl.GenlPurchaseEkpoImpl#getAedat <em>Aedat</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.sap.SapSrmPurchase.impl.GenlPurchaseEkpoImpl#getTxz01 <em>Txz01</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.sap.SapSrmPurchase.impl.GenlPurchaseEkpoImpl#getMatnr <em>Matnr</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.sap.SapSrmPurchase.impl.GenlPurchaseEkpoImpl#getEmatn <em>Ematn</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.sap.SapSrmPurchase.impl.GenlPurchaseEkpoImpl#getBukrs <em>Bukrs</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.sap.SapSrmPurchase.impl.GenlPurchaseEkpoImpl#getWerks <em>Werks</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.sap.SapSrmPurchase.impl.GenlPurchaseEkpoImpl#getLgort <em>Lgort</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.sap.SapSrmPurchase.impl.GenlPurchaseEkpoImpl#getBednr <em>Bednr</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.sap.SapSrmPurchase.impl.GenlPurchaseEkpoImpl#getMatkl <em>Matkl</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.sap.SapSrmPurchase.impl.GenlPurchaseEkpoImpl#getMenge <em>Menge</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.sap.SapSrmPurchase.impl.GenlPurchaseEkpoImpl#getMeins <em>Meins</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.sap.SapSrmPurchase.impl.GenlPurchaseEkpoImpl#getElikz <em>Elikz</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.sap.SapSrmPurchase.impl.GenlPurchaseEkpoImpl#getErekz <em>Erekz</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.sap.SapSrmPurchase.impl.GenlPurchaseEkpoImpl#getPstyp <em>Pstyp</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.sap.SapSrmPurchase.impl.GenlPurchaseEkpoImpl#getKnttp <em>Knttp</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.sap.SapSrmPurchase.impl.GenlPurchaseEkpoImpl#getLmein <em>Lmein</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.sap.SapSrmPurchase.impl.GenlPurchaseEkpoImpl#getMwskz <em>Mwskz</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.sap.SapSrmPurchase.impl.GenlPurchaseEkpoImpl#getStats <em>Stats</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.sap.SapSrmPurchase.impl.GenlPurchaseEkpoImpl#getStatu <em>Statu</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.sap.SapSrmPurchase.impl.GenlPurchaseEkpoImpl#getUebto <em>Uebto</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.sap.SapSrmPurchase.impl.GenlPurchaseEkpoImpl#getUebtk <em>Uebtk</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.sap.SapSrmPurchase.impl.GenlPurchaseEkpoImpl#getUntto <em>Untto</em>}</li>
 * </ul>
 * </p>
 *
 * @extends ExtendedDataObjectImpl;
 *
 * @implements GenlPurchaseEkpo;
 */

public class GenlPurchaseEkpoImpl extends ExtendedDataObjectImpl implements GenlPurchaseEkpo {
	/**
	...
	public final static int INDEX_MATKL = 11;
	...
	public final static int INDEX_UEBTO = 22;
	public final static int INDEX_UEBTK = 23;
	public final static int INDEX_UNTTO = 24;
	 ...
	 * <!-- end-user-doc -->
	 */
	public GenlPurchaseEkpoImpl(Type type) {
		super(type);
	}
	...
	public String getUebto() {
		return DataUtil.toString(super.getByIndex(INDEX_UEBTO, true));
	}

	/**
	 * Sets the value of the '{@link com.primeton.eos.Test#getUebto <em>Uebto</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public void setUebto(String uebto) {
		super.setByIndex(INDEX_UEBTO, uebto);
	}
	...
	public String getUebtk() {
		return DataUtil.toString(super.getByIndex(INDEX_UEBTK, true));
	}

	/**
	 * Sets the value of the '{@link com.primeton.eos.Test#getUebtk <em>Uebtk</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public void setUebtk(String uebtk) {
		super.setByIndex(INDEX_UEBTK, uebtk);
	}
	...
	public String getUntto() {
		return DataUtil.toString(super.getByIndex(INDEX_UNTTO, true));
	}

	/**
	 * Sets the value of the '{@link com.primeton.eos.Test#getUntto <em>Untto</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public void setUntto(String untto) {
		super.setByIndex(INDEX_UNTTO, untto);
	}
