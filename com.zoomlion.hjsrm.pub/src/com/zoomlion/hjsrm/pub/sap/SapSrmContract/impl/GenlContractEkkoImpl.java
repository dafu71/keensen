 ...
 * <ul>
 *   <li>{@link com.zoomlion.hjsrm.pub.sap.SapSrmContract.impl.GenlContractEkkoImpl#getEbeln <em>Ebeln</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.sap.SapSrmContract.impl.GenlContractEkkoImpl#getBukrs <em>Bukrs</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.sap.SapSrmContract.impl.GenlContractEkkoImpl#getBstyp <em>Bstyp</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.sap.SapSrmContract.impl.GenlContractEkkoImpl#getBsart <em>Bsart</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.sap.SapSrmContract.impl.GenlContractEkkoImpl#getLoekz <em>Loekz</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.sap.SapSrmContract.impl.GenlContractEkkoImpl#getAedat <em>Aedat</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.sap.SapSrmContract.impl.GenlContractEkkoImpl#getErnam <em>Ernam</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.sap.SapSrmContract.impl.GenlContractEkkoImpl#getLifnr <em>Lifnr</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.sap.SapSrmContract.impl.GenlContractEkkoImpl#getSpras <em>Spras</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.sap.SapSrmContract.impl.GenlContractEkkoImpl#getEkorg <em>Ekorg</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.sap.SapSrmContract.impl.GenlContractEkkoImpl#getEkgrp <em>Ekgrp</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.sap.SapSrmContract.impl.GenlContractEkkoImpl#getWaers <em>Waers</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.sap.SapSrmContract.impl.GenlContractEkkoImpl#getBedat <em>Bedat</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.sap.SapSrmContract.impl.GenlContractEkkoImpl#getKdatb <em>Kdatb</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.sap.SapSrmContract.impl.GenlContractEkkoImpl#getKdate <em>Kdate</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.sap.SapSrmContract.impl.GenlContractEkkoImpl#getIhrez <em>Ihrez</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.sap.SapSrmContract.impl.GenlContractEkkoImpl#getVerkf <em>Verkf</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.sap.SapSrmContract.impl.GenlContractEkkoImpl#getStats <em>Stats</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.sap.SapSrmContract.impl.GenlContractEkkoImpl#getTranu <em>Tranu</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.sap.SapSrmContract.impl.GenlContractEkkoImpl#getTrant <em>Trant</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.sap.SapSrmContract.impl.GenlContractEkkoImpl#getKnumv <em>Knumv</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.sap.SapSrmContract.impl.GenlContractEkkoImpl#getFrgrl <em>Frgrl</em>}</li>
 * </ul>
 * </p>
 *
 * @extends ExtendedDataObjectImpl;
 *
 * @implements GenlContractEkko;
 */

public class GenlContractEkkoImpl extends ExtendedDataObjectImpl implements GenlContractEkko {
	/**
	...
	public final static int INDEX_FRGRL = 21;
	 ...
	 * <!-- end-user-doc -->
	 */
	public GenlContractEkkoImpl(Type type) {
		super(type);
	}
	...
	public String getFrgrl() {
		return DataUtil.toString(super.getByIndex(INDEX_FRGRL, true));
	}

	/**
	 * Sets the value of the '{@link com.primeton.eos.Test#getFrgrl <em>Frgrl</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public void setFrgrl(String frgrl) {
		super.setByIndex(INDEX_FRGRL, frgrl);
	}
