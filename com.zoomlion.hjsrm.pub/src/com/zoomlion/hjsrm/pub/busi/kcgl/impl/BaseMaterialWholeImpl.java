...
import com.zoomlion.hjsrm.pub.busi.kcgl.BaseMaterialWhole;
 ...
 * <ul>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.kcgl.impl.BaseMaterialWholeImpl#getMatnr <em>Matnr</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.kcgl.impl.BaseMaterialWholeImpl#getZcpcx <em>Zcpcx</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.kcgl.impl.BaseMaterialWholeImpl#getModifyby <em>Modifyby</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.kcgl.impl.BaseMaterialWholeImpl#getModifybyname <em>Modifybyname</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.kcgl.impl.BaseMaterialWholeImpl#getModifytime <em>Modifytime</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.kcgl.impl.BaseMaterialWholeImpl#getStand <em>Stand</em>}</li>
 * </ul>
 * </p>
 *
 * @extends ExtendedDataObjectImpl;
 *
 * @implements BaseMaterialWhole;
 */

public class BaseMaterialWholeImpl extends ExtendedDataObjectImpl implements BaseMaterialWhole {
	/**
	 * Comment for <code>serialVersionUID</code>
	 */
	private static final long serialVersionUID = 1L;
	public final static int INDEX_MATNR = 0;
	public final static int INDEX_ZCPCX = 1;
	public final static int INDEX_MODIFYBY = 2;
	public final static int INDEX_MODIFYBYNAME = 3;
	 ...
	 * <!-- end-user-doc -->
	 */
	public BaseMaterialWholeImpl(Type type) {
		super(type);
	}
