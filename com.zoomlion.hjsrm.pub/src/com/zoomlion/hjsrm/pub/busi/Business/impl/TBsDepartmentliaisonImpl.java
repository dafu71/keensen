...
import com.zoomlion.hjsrm.pub.busi.Business.TBsDepartmentliaison;
 ...
 * <ul>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsDepartmentliaisonImpl#getPkid <em>Pkid</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsDepartmentliaisonImpl#getWorklistinfopkid <em>Worklistinfopkid</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsDepartmentliaisonImpl#getWorkitemid <em>Workitemid</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsDepartmentliaisonImpl#getBusitype <em>Busitype</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsDepartmentliaisonImpl#getUserid <em>Userid</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsDepartmentliaisonImpl#getWorktype <em>Worktype</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsDepartmentliaisonImpl#getSendorgid <em>Sendorgid</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsDepartmentliaisonImpl#getSendby <em>Sendby</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsDepartmentliaisonImpl#getSendday <em>Sendday</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsDepartmentliaisonImpl#getHandleorgid <em>Handleorgid</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsDepartmentliaisonImpl#getHandleby <em>Handleby</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsDepartmentliaisonImpl#getProvidecompleteday <em>Providecompleteday</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsDepartmentliaisonImpl#getIsurgent <em>Isurgent</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsDepartmentliaisonImpl#getContentabstract <em>Contentabstract</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsDepartmentliaisonImpl#getHandleresult <em>Handleresult</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsDepartmentliaisonImpl#getStand <em>Stand</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsDepartmentliaisonImpl#getCreateby <em>Createby</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsDepartmentliaisonImpl#getCreatetime <em>Createtime</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsDepartmentliaisonImpl#getModifyby <em>Modifyby</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsDepartmentliaisonImpl#getUpdatetime <em>Updatetime</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsDepartmentliaisonImpl#getDataorgid <em>Dataorgid</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsDepartmentliaisonImpl#getDelflag <em>Delflag</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsDepartmentliaisonImpl#getRemark <em>Remark</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsDepartmentliaisonImpl#getCreateorgid <em>Createorgid</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsDepartmentliaisonImpl#getUsername <em>Username</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsDepartmentliaisonImpl#getContactphone <em>Contactphone</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsDepartmentliaisonImpl#getMobile <em>Mobile</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsDepartmentliaisonImpl#getAddrdetail <em>Addrdetail</em>}</li>
 * </ul>
 * </p>
 *
 * @extends ExtendedDataObjectImpl;
 *
 * @implements TBsDepartmentliaison;
 */

public class TBsDepartmentliaisonImpl extends ExtendedDataObjectImpl implements TBsDepartmentliaison {
	/**
	 * Comment for <code>serialVersionUID</code>
	 */
	private static final long serialVersionUID = 1L;
	public final static int INDEX_PKID = 0;
	public final static int INDEX_WORKLISTINFOPKID = 1;
	public final static int INDEX_WORKITEMID = 2;
	public final static int INDEX_BUSITYPE = 3;
	public final static int INDEX_USERID = 4;
	public final static int INDEX_WORKTYPE = 5;
	public final static int INDEX_SENDORGID = 6;
	public final static int INDEX_SENDBY = 7;
	public final static int INDEX_SENDDAY = 8;
	public final static int INDEX_HANDLEORGID = 9;
	public final static int INDEX_HANDLEBY = 10;
	public final static int INDEX_PROVIDECOMPLETEDAY = 11;
	public final static int INDEX_ISURGENT = 12;
	public final static int INDEX_CONTENTABSTRACT = 13;
	public final static int INDEX_HANDLERESULT = 14;
	...
	public final static int INDEX_CREATEORGID = 23;
	public final static int INDEX_USERNAME = 24;
	public final static int INDEX_CONTACTPHONE = 25;
	public final static int INDEX_MOBILE = 26;
	public final static int INDEX_ADDRDETAIL = 27;
	 ...
	 * <!-- end-user-doc -->
	 */
	public TBsDepartmentliaisonImpl() {
		this(TYPE);
	}
	 ...
	 * <!-- end-user-doc -->
	 */
	public TBsDepartmentliaisonImpl(Type type) {
		super(type);
	}
	...
	public int getSendorgid() {
		return DataUtil.toInt(super.getByIndex(INDEX_SENDORGID, true));
	}

	/**
	 * Sets the value of the '{@link com.primeton.eos.Test#getSendorgid <em>Sendorgid</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public void setSendorgid(int sendorgid) {
		super.setByIndex(INDEX_SENDORGID, sendorgid);
	}
	...
	public String getSendby() {
		return DataUtil.toString(super.getByIndex(INDEX_SENDBY, true));
	}

	/**
	 * Sets the value of the '{@link com.primeton.eos.Test#getSendby <em>Sendby</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public void setSendby(String sendby) {
		super.setByIndex(INDEX_SENDBY, sendby);
	}
	...
	public Date getSendday() {
		return DataUtil.toDate(super.getByIndex(INDEX_SENDDAY, true));
	}

	/**
	 * Sets the value of the '{@link com.primeton.eos.Test#getSendday <em>Sendday</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public void setSendday(Date sendday) {
		super.setByIndex(INDEX_SENDDAY, sendday);
	}
	...
	public int getHandleorgid() {
		return DataUtil.toInt(super.getByIndex(INDEX_HANDLEORGID, true));
	}

	/**
	 * Sets the value of the '{@link com.primeton.eos.Test#getHandleorgid <em>Handleorgid</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public void setHandleorgid(int handleorgid) {
		super.setByIndex(INDEX_HANDLEORGID, handleorgid);
	}
	...
	public String getHandleby() {
		return DataUtil.toString(super.getByIndex(INDEX_HANDLEBY, true));
	}

	/**
	 * Sets the value of the '{@link com.primeton.eos.Test#getHandleby <em>Handleby</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public void setHandleby(String handleby) {
		super.setByIndex(INDEX_HANDLEBY, handleby);
	}
	...
	public Date getProvidecompleteday() {
		return DataUtil.toDate(super.getByIndex(INDEX_PROVIDECOMPLETEDAY, true));
	}

	/**
	 * Sets the value of the '{@link com.primeton.eos.Test#getProvidecompleteday <em>Providecompleteday</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public void setProvidecompleteday(Date providecompleteday) {
		super.setByIndex(INDEX_PROVIDECOMPLETEDAY, providecompleteday);
	}
	...
	public String getIsurgent() {
		return DataUtil.toString(super.getByIndex(INDEX_ISURGENT, true));
	}

	/**
	 * Sets the value of the '{@link com.primeton.eos.Test#getIsurgent <em>Isurgent</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public void setIsurgent(String isurgent) {
		super.setByIndex(INDEX_ISURGENT, isurgent);
	}
	...
	public String getContentabstract() {
		return DataUtil.toString(super.getByIndex(INDEX_CONTENTABSTRACT, true));
	}

	/**
	 * Sets the value of the '{@link com.primeton.eos.Test#getContentabstract <em>Contentabstract</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public void setContentabstract(String contentabstract) {
		super.setByIndex(INDEX_CONTENTABSTRACT, contentabstract);
	}
	...
	public String getHandleresult() {
		return DataUtil.toString(super.getByIndex(INDEX_HANDLERESULT, true));
	}

	/**
	 * Sets the value of the '{@link com.primeton.eos.Test#getHandleresult <em>Handleresult</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public void setHandleresult(String handleresult) {
		super.setByIndex(INDEX_HANDLERESULT, handleresult);
	}
