...
import com.zoomlion.hjsrm.pub.busi.Business.TBsTimeoutinfo;
 ...
 * <ul>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsTimeoutinfoImpl#getPkid <em>Pkid</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsTimeoutinfoImpl#getWorkitemid <em>Workitemid</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsTimeoutinfoImpl#getTimeoutdesc <em>Timeoutdesc</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsTimeoutinfoImpl#getOptrcode <em>Optrcode</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsTimeoutinfoImpl#getOptdate <em>Optdate</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsTimeoutinfoImpl#getRemark <em>Remark</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsTimeoutinfoImpl#getStand <em>Stand</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsTimeoutinfoImpl#getCreateby <em>Createby</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsTimeoutinfoImpl#getCreateorgid <em>Createorgid</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsTimeoutinfoImpl#getCreatetime <em>Createtime</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsTimeoutinfoImpl#getModifyby <em>Modifyby</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsTimeoutinfoImpl#getUpdatetime <em>Updatetime</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsTimeoutinfoImpl#getDataorgid <em>Dataorgid</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsTimeoutinfoImpl#getDelflag <em>Delflag</em>}</li>
 * </ul>
 * </p>
 *
 * @extends ExtendedDataObjectImpl;
 *
 * @implements TBsTimeoutinfo;
 */

public class TBsTimeoutinfoImpl extends ExtendedDataObjectImpl implements TBsTimeoutinfo {
	/**
	...
	public final static int INDEX_TIMEOUTDESC = 2;
	public final static int INDEX_OPTRCODE = 3;
	public final static int INDEX_OPTDATE = 4;
	 ...
	 * <!-- end-user-doc -->
	 */
	public TBsTimeoutinfoImpl(Type type) {
		super(type);
	}
	...
	public String getTimeoutdesc() {
		return DataUtil.toString(super.getByIndex(INDEX_TIMEOUTDESC, true));
	}

	/**
	 * Sets the value of the '{@link com.primeton.eos.Test#getTimeoutdesc <em>Timeoutdesc</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public void setTimeoutdesc(String timeoutdesc) {
		super.setByIndex(INDEX_TIMEOUTDESC, timeoutdesc);
	}
