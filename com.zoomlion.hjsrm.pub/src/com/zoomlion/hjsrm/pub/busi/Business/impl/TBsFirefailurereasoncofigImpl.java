...
import com.zoomlion.hjsrm.pub.busi.Business.TBsFirefailurereasoncofig;
 ...
 * <ul>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsFirefailurereasoncofigImpl#getPkid <em>Pkid</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsFirefailurereasoncofigImpl#getIstop <em>Istop</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsFirefailurereasoncofigImpl#getParentpkid <em>Parentpkid</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsFirefailurereasoncofigImpl#getReasonsdetail <em>Reasonsdetail</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsFirefailurereasoncofigImpl#getRemark <em>Remark</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsFirefailurereasoncofigImpl#getStand <em>Stand</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsFirefailurereasoncofigImpl#getCreateby <em>Createby</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsFirefailurereasoncofigImpl#getCreateorgid <em>Createorgid</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsFirefailurereasoncofigImpl#getCreatetime <em>Createtime</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsFirefailurereasoncofigImpl#getModifyby <em>Modifyby</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsFirefailurereasoncofigImpl#getUpdatetime <em>Updatetime</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsFirefailurereasoncofigImpl#getDataorgid <em>Dataorgid</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsFirefailurereasoncofigImpl#getDelflag <em>Delflag</em>}</li>
 * </ul>
 * </p>
 *
 * @extends ExtendedDataObjectImpl;
 *
 * @implements TBsFirefailurereasoncofig;
 */

public class TBsFirefailurereasoncofigImpl extends ExtendedDataObjectImpl implements TBsFirefailurereasoncofig {
	/**
	 * Comment for <code>serialVersionUID</code>
	 */
	private static final long serialVersionUID = 1L;
	public final static int INDEX_PKID = 0;
	public final static int INDEX_ISTOP = 1;
	public final static int INDEX_PARENTPKID = 2;
	public final static int INDEX_REASONSDETAIL = 3;
	 ...
	 * <!-- end-user-doc -->
	 */
	public TBsFirefailurereasoncofigImpl() {
		this(TYPE);
	}
	 ...
	 * <!-- end-user-doc -->
	 */
	public TBsFirefailurereasoncofigImpl(Type type) {
		super(type);
	}
