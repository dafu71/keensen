...
import com.zoomlion.hjsrm.pub.busi.Business.TBsReservamountmodelext;
 ...
 * <ul>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsReservamountmodelextImpl#getPkid <em>Pkid</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsReservamountmodelextImpl#getReservamountmodelpkid <em>Reservamountmodelpkid</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsReservamountmodelextImpl#getStarttime <em>Starttime</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsReservamountmodelextImpl#getEndtime <em>Endtime</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsReservamountmodelextImpl#getResered <em>Resered</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsReservamountmodelextImpl#getAdded <em>Added</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsReservamountmodelextImpl#getState <em>State</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsReservamountmodelextImpl#getRemark <em>Remark</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsReservamountmodelextImpl#getStand <em>Stand</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsReservamountmodelextImpl#getCreateby <em>Createby</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsReservamountmodelextImpl#getCreateorgid <em>Createorgid</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsReservamountmodelextImpl#getCreatetime <em>Createtime</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsReservamountmodelextImpl#getModifyby <em>Modifyby</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsReservamountmodelextImpl#getUpdatetime <em>Updatetime</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsReservamountmodelextImpl#getDataorgid <em>Dataorgid</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsReservamountmodelextImpl#getDelflag <em>Delflag</em>}</li>
 * </ul>
 * </p>
 *
 * @extends ExtendedDataObjectImpl;
 *
 * @implements TBsReservamountmodelext;
 */

public class TBsReservamountmodelextImpl extends ExtendedDataObjectImpl implements TBsReservamountmodelext {
	/**
	 * Comment for <code>serialVersionUID</code>
	 */
	private static final long serialVersionUID = 1L;
	public final static int INDEX_PKID = 0;
	public final static int INDEX_RESERVAMOUNTMODELPKID = 1;
	 ...
	 * <!-- end-user-doc -->
	 */
	public TBsReservamountmodelextImpl() {
		this(TYPE);
	}
	 ...
	 * <!-- end-user-doc -->
	 */
	public TBsReservamountmodelextImpl(Type type) {
		super(type);
	}
	...
	public String getReservamountmodelpkid() {
		return DataUtil.toString(super.getByIndex(INDEX_RESERVAMOUNTMODELPKID, true));
	}

	/**
	 * Sets the value of the '{@link com.primeton.eos.Test#getReservamountmodelpkid <em>Reservamountmodelpkid</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public void setReservamountmodelpkid(String reservamountmodelpkid) {
		super.setByIndex(INDEX_RESERVAMOUNTMODELPKID, reservamountmodelpkid);
	}
