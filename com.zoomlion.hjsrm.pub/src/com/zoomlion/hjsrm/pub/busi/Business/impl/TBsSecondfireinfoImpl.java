...
import com.zoomlion.hjsrm.pub.busi.Business.TBsSecondfireinfo;
 ...
 * <ul>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsSecondfireinfoImpl#getPkid <em>Pkid</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsSecondfireinfoImpl#getPlaninfopkid <em>Planinfopkid</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsSecondfireinfoImpl#getWorklistinfopkid <em>Worklistinfopkid</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsSecondfireinfoImpl#getWorkitemid <em>Workitemid</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsSecondfireinfoImpl#getBusitype <em>Busitype</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsSecondfireinfoImpl#getUserid <em>Userid</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsSecondfireinfoImpl#getSecondfiredate <em>Secondfiredate</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsSecondfireinfoImpl#getSecondfireoptr <em>Secondfireoptr</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsSecondfireinfoImpl#getSecondfiredepartment <em>Secondfiredepartment</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsSecondfireinfoImpl#getSecondfiredesc <em>Secondfiredesc</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsSecondfireinfoImpl#getRemark <em>Remark</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsSecondfireinfoImpl#getStand <em>Stand</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsSecondfireinfoImpl#getCreateby <em>Createby</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsSecondfireinfoImpl#getCreateorgid <em>Createorgid</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsSecondfireinfoImpl#getCreatetime <em>Createtime</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsSecondfireinfoImpl#getModifyby <em>Modifyby</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsSecondfireinfoImpl#getUpdatetime <em>Updatetime</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsSecondfireinfoImpl#getDataorgid <em>Dataorgid</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsSecondfireinfoImpl#getDelflag <em>Delflag</em>}</li>
 * </ul>
 * </p>
 *
 * @extends ExtendedDataObjectImpl;
 *
 * @implements TBsSecondfireinfo;
 */

public class TBsSecondfireinfoImpl extends ExtendedDataObjectImpl implements TBsSecondfireinfo {
	/**
	...
	public final static int INDEX_SECONDFIREDATE = 6;
	public final static int INDEX_SECONDFIREOPTR = 7;
	public final static int INDEX_SECONDFIREDEPARTMENT = 8;
	public final static int INDEX_SECONDFIREDESC = 9;
	 ...
	 * <!-- end-user-doc -->
	 */
	public TBsSecondfireinfoImpl(Type type) {
		super(type);
	}
	...
	public Date getSecondfiredate() {
		return DataUtil.toDate(super.getByIndex(INDEX_SECONDFIREDATE, true));
	}

	/**
	 * Sets the value of the '{@link com.primeton.eos.Test#getSecondfiredate <em>Secondfiredate</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public void setSecondfiredate(Date secondfiredate) {
		super.setByIndex(INDEX_SECONDFIREDATE, secondfiredate);
	}
	...
	public String getSecondfireoptr() {
		return DataUtil.toString(super.getByIndex(INDEX_SECONDFIREOPTR, true));
	}

	/**
	 * Sets the value of the '{@link com.primeton.eos.Test#getSecondfireoptr <em>Secondfireoptr</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public void setSecondfireoptr(String secondfireoptr) {
		super.setByIndex(INDEX_SECONDFIREOPTR, secondfireoptr);
	}
	...
	public String getSecondfiredepartment() {
		return DataUtil.toString(super.getByIndex(INDEX_SECONDFIREDEPARTMENT, true));
	}

	/**
	 * Sets the value of the '{@link com.primeton.eos.Test#getSecondfiredepartment <em>Secondfiredepartment</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public void setSecondfiredepartment(String secondfiredepartment) {
		super.setByIndex(INDEX_SECONDFIREDEPARTMENT, secondfiredepartment);
	}
	...
	public String getSecondfiredesc() {
		return DataUtil.toString(super.getByIndex(INDEX_SECONDFIREDESC, true));
	}

	/**
	 * Sets the value of the '{@link com.primeton.eos.Test#getSecondfiredesc <em>Secondfiredesc</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public void setSecondfiredesc(String secondfiredesc) {
		super.setByIndex(INDEX_SECONDFIREDESC, secondfiredesc);
	}
