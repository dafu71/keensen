...
import com.zoomlion.hjsrm.pub.busi.Business.TBsTransferrecord;
 ...
 * <ul>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsTransferrecordImpl#getPkid <em>Pkid</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsTransferrecordImpl#getWorkitemid <em>Workitemid</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsTransferrecordImpl#getUserid <em>Userid</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsTransferrecordImpl#getOldcustid <em>Oldcustid</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsTransferrecordImpl#getNewcustid <em>Newcustid</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsTransferrecordImpl#getTransferdate <em>Transferdate</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsTransferrecordImpl#getCreateby <em>Createby</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsTransferrecordImpl#getCreateorgid <em>Createorgid</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsTransferrecordImpl#getCreatetime <em>Createtime</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsTransferrecordImpl#getModifyby <em>Modifyby</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsTransferrecordImpl#getUpdatetime <em>Updatetime</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsTransferrecordImpl#getDataorgid <em>Dataorgid</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsTransferrecordImpl#getDelflag <em>Delflag</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsTransferrecordImpl#getPlaninfopkid <em>Planinfopkid</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsTransferrecordImpl#getWorklistinfopkid <em>Worklistinfopkid</em>}</li>
 * </ul>
 * </p>
 *
 * @extends ExtendedDataObjectImpl;
 *
 * @implements TBsTransferrecord;
 */

public class TBsTransferrecordImpl extends ExtendedDataObjectImpl implements TBsTransferrecord {
	/**
	...
	public final static int INDEX_OLDCUSTID = 3;
	public final static int INDEX_NEWCUSTID = 4;
	public final static int INDEX_TRANSFERDATE = 5;
	 ...
	 * <!-- end-user-doc -->
	 */
	public TBsTransferrecordImpl(Type type) {
		super(type);
	}
	...
	public String getOldcustid() {
		return DataUtil.toString(super.getByIndex(INDEX_OLDCUSTID, true));
	}

	/**
	 * Sets the value of the '{@link com.primeton.eos.Test#getOldcustid <em>Oldcustid</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public void setOldcustid(String oldcustid) {
		super.setByIndex(INDEX_OLDCUSTID, oldcustid);
	}
	...
	public String getNewcustid() {
		return DataUtil.toString(super.getByIndex(INDEX_NEWCUSTID, true));
	}

	/**
	 * Sets the value of the '{@link com.primeton.eos.Test#getNewcustid <em>Newcustid</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public void setNewcustid(String newcustid) {
		super.setByIndex(INDEX_NEWCUSTID, newcustid);
	}
	...
	public Date getTransferdate() {
		return DataUtil.toDate(super.getByIndex(INDEX_TRANSFERDATE, true));
	}

	/**
	 * Sets the value of the '{@link com.primeton.eos.Test#getTransferdate <em>Transferdate</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public void setTransferdate(Date transferdate) {
		super.setByIndex(INDEX_TRANSFERDATE, transferdate);
	}
