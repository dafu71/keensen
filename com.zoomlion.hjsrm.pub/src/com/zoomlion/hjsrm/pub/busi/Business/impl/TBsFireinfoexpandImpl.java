...
import com.zoomlion.hjsrm.pub.busi.Business.TBsFireinfoexpand;
 ...
 * <ul>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsFireinfoexpandImpl#getPkid <em>Pkid</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsFireinfoexpandImpl#getFireinfopkid <em>Fireinfopkid</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsFireinfoexpandImpl#getRemainheadinfopkid <em>Remainheadinfopkid</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsFireinfoexpandImpl#getRemainheadfirecount <em>Remainheadfirecount</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsFireinfoexpandImpl#getRemark <em>Remark</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsFireinfoexpandImpl#getStand <em>Stand</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsFireinfoexpandImpl#getCreateby <em>Createby</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsFireinfoexpandImpl#getCreateorgid <em>Createorgid</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsFireinfoexpandImpl#getCreatetime <em>Createtime</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsFireinfoexpandImpl#getModifyby <em>Modifyby</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsFireinfoexpandImpl#getUpdatetime <em>Updatetime</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsFireinfoexpandImpl#getDataorgid <em>Dataorgid</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsFireinfoexpandImpl#getDelflag <em>Delflag</em>}</li>
 * </ul>
 * </p>
 *
 * @extends ExtendedDataObjectImpl;
 *
 * @implements TBsFireinfoexpand;
 */

public class TBsFireinfoexpandImpl extends ExtendedDataObjectImpl implements TBsFireinfoexpand {
	/**
	...
	public final static int INDEX_REMAINHEADINFOPKID = 2;
	public final static int INDEX_REMAINHEADFIRECOUNT = 3;
	 ...
	 * <!-- end-user-doc -->
	 */
	public TBsFireinfoexpandImpl(Type type) {
		super(type);
	}
	...
	public String getRemainheadinfopkid() {
		return DataUtil.toString(super.getByIndex(INDEX_REMAINHEADINFOPKID, true));
	}

	/**
	 * Sets the value of the '{@link com.primeton.eos.Test#getRemainheadinfopkid <em>Remainheadinfopkid</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public void setRemainheadinfopkid(String remainheadinfopkid) {
		super.setByIndex(INDEX_REMAINHEADINFOPKID, remainheadinfopkid);
	}
	...
	public int getRemainheadfirecount() {
		return DataUtil.toInt(super.getByIndex(INDEX_REMAINHEADFIRECOUNT, true));
	}

	/**
	 * Sets the value of the '{@link com.primeton.eos.Test#getRemainheadfirecount <em>Remainheadfirecount</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public void setRemainheadfirecount(int remainheadfirecount) {
		super.setByIndex(INDEX_REMAINHEADFIRECOUNT, remainheadfirecount);
	}
