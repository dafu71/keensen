...
import com.zoomlion.hjsrm.pub.busi.Business.TBsUsertypechangerec;
 ...
 * <ul>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsUsertypechangerecImpl#getPkid <em>Pkid</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsUsertypechangerecImpl#getWorklistinfopkid <em>Worklistinfopkid</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsUsertypechangerecImpl#getWorkitemid <em>Workitemid</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsUsertypechangerecImpl#getBusitype <em>Busitype</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsUsertypechangerecImpl#getUserid <em>Userid</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsUsertypechangerecImpl#getOlduserid <em>Olduserid</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsUsertypechangerecImpl#getUsertype <em>Usertype</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsUsertypechangerecImpl#getOldusertype <em>Oldusertype</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsUsertypechangerecImpl#getChangedate <em>Changedate</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsUsertypechangerecImpl#getStand <em>Stand</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsUsertypechangerecImpl#getCreateby <em>Createby</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsUsertypechangerecImpl#getCreatetime <em>Createtime</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsUsertypechangerecImpl#getModifyby <em>Modifyby</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsUsertypechangerecImpl#getUpdatetime <em>Updatetime</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsUsertypechangerecImpl#getDataorgid <em>Dataorgid</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsUsertypechangerecImpl#getDelflag <em>Delflag</em>}</li>
 * </ul>
 * </p>
 *
 * @extends ExtendedDataObjectImpl;
 *
 * @implements TBsUsertypechangerec;
 */

public class TBsUsertypechangerecImpl extends ExtendedDataObjectImpl implements TBsUsertypechangerec {
	/**
	...
	public final static int INDEX_OLDUSERID = 5;
	public final static int INDEX_USERTYPE = 6;
	public final static int INDEX_OLDUSERTYPE = 7;
	public final static int INDEX_CHANGEDATE = 8;
	 ...
	 * <!-- end-user-doc -->
	 */
	public TBsUsertypechangerecImpl() {
		this(TYPE);
	}
	 ...
	 * <!-- end-user-doc -->
	 */
	public TBsUsertypechangerecImpl(Type type) {
		super(type);
	}
	...
	public String getOlduserid() {
		return DataUtil.toString(super.getByIndex(INDEX_OLDUSERID, true));
	}

	/**
	 * Sets the value of the '{@link com.primeton.eos.Test#getOlduserid <em>Olduserid</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public void setOlduserid(String olduserid) {
		super.setByIndex(INDEX_OLDUSERID, olduserid);
	}
	...
	public String getOldusertype() {
		return DataUtil.toString(super.getByIndex(INDEX_OLDUSERTYPE, true));
	}

	/**
	 * Sets the value of the '{@link com.primeton.eos.Test#getOldusertype <em>Oldusertype</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public void setOldusertype(String oldusertype) {
		super.setByIndex(INDEX_OLDUSERTYPE, oldusertype);
	}
