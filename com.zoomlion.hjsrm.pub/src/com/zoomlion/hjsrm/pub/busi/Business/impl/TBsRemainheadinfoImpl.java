...
import com.zoomlion.hjsrm.pub.busi.Business.TBsRemainheadinfo;
 ...
 * <ul>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsRemainheadinfoImpl#getPkid <em>Pkid</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsRemainheadinfoImpl#getSupplymeterpkid <em>Supplymeterpkid</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsRemainheadinfoImpl#getUserid <em>Userid</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsRemainheadinfoImpl#getRemainheadtype <em>Remainheadtype</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsRemainheadinfoImpl#getRemark <em>Remark</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsRemainheadinfoImpl#getStand <em>Stand</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsRemainheadinfoImpl#getCreateby <em>Createby</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsRemainheadinfoImpl#getCreateorgid <em>Createorgid</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsRemainheadinfoImpl#getCreatetime <em>Createtime</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsRemainheadinfoImpl#getModifyby <em>Modifyby</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsRemainheadinfoImpl#getUpdatetime <em>Updatetime</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsRemainheadinfoImpl#getDataorgid <em>Dataorgid</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsRemainheadinfoImpl#getDelflag <em>Delflag</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.Business.impl.TBsRemainheadinfoImpl#getRemainheadcount <em>Remainheadcount</em>}</li>
 * </ul>
 * </p>
 *
 * @extends ExtendedDataObjectImpl;
 *
 * @implements TBsRemainheadinfo;
 */

public class TBsRemainheadinfoImpl extends ExtendedDataObjectImpl implements TBsRemainheadinfo {
	/**
	 * Comment for <code>serialVersionUID</code>
	 */
	private static final long serialVersionUID = 1L;
	public final static int INDEX_PKID = 0;
	public final static int INDEX_SUPPLYMETERPKID = 1;
	public final static int INDEX_USERID = 2;
	public final static int INDEX_REMAINHEADTYPE = 3;
	...
	public final static int INDEX_REMAINHEADCOUNT = 13;
	 ...
	 * <!-- end-user-doc -->
	 */
	public TBsRemainheadinfoImpl(Type type) {
		super(type);
	}
	...
	public String getSupplymeterpkid() {
		return DataUtil.toString(super.getByIndex(INDEX_SUPPLYMETERPKID, true));
	}

	/**
	 * Sets the value of the '{@link com.primeton.eos.Test#getSupplymeterpkid <em>Supplymeterpkid</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public void setSupplymeterpkid(String supplymeterpkid) {
		super.setByIndex(INDEX_SUPPLYMETERPKID, supplymeterpkid);
	}
	...
	public String getRemainheadtype() {
		return DataUtil.toString(super.getByIndex(INDEX_REMAINHEADTYPE, true));
	}

	/**
	 * Sets the value of the '{@link com.primeton.eos.Test#getRemainheadtype <em>Remainheadtype</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public void setRemainheadtype(String remainheadtype) {
		super.setByIndex(INDEX_REMAINHEADTYPE, remainheadtype);
	}
	...
	public int getRemainheadcount() {
		return DataUtil.toInt(super.getByIndex(INDEX_REMAINHEADCOUNT, true));
	}

	/**
	 * Sets the value of the '{@link com.primeton.eos.Test#getRemainheadcount <em>Remainheadcount</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public void setRemainheadcount(int remainheadcount) {
		super.setByIndex(INDEX_REMAINHEADCOUNT, remainheadcount);
	}
