 ...
 * <ul>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.delivery.delivery.impl.GenlVegicleListImpl#getCxdm <em>Cxdm</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.delivery.delivery.impl.GenlVegicleListImpl#getCxmc <em>Cxmc</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.delivery.delivery.impl.GenlVegicleListImpl#getWerks <em>Werks</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.delivery.delivery.impl.GenlVegicleListImpl#getBukrs <em>Bukrs</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.delivery.delivery.impl.GenlVegicleListImpl#getStatu <em>Statu</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.delivery.delivery.impl.GenlVegicleListImpl#getTranu <em>Tranu</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.pub.busi.delivery.delivery.impl.GenlVegicleListImpl#getTrant <em>Trant</em>}</li>
 * </ul>
 * </p>
 *
 * @extends ExtendedDataObjectImpl;
 *
 * @implements GenlVegicleList;
 */

public class GenlVegicleListImpl extends ExtendedDataObjectImpl implements GenlVegicleList {
	/**
	 * Comment for <code>serialVersionUID</code>
	 */
	private static final long serialVersionUID = 1L;
	public final static int INDEX_CXDM = 0;
	public final static int INDEX_CXMC = 1;
	 ...
	 * <!-- end-user-doc -->
	 */
	public GenlVegicleListImpl(Type type) {
		super(type);
	}
	...
	public String getCxmc() {
		return DataUtil.toString(super.getByIndex(INDEX_CXMC, true));
	}

	/**
	 * Sets the value of the '{@link com.primeton.eos.Test#getCxmc <em>Cxmc</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public void setCxmc(String cxmc) {
		super.setByIndex(INDEX_CXMC, cxmc);
	}
