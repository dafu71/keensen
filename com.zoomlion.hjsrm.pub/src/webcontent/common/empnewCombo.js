...
/**
 * 
 * @class com.zoomlion.hjsrm.empnewCombo
 * @extends Ext.Window
 *          <p>
 *          选择参与者弹出框
 */
com.zoomlion.hjsrm.empnewComboWindow = Ext.extend(Ext.Window, {
	title : '选择机构',// 标题栏
	partTitle : '机构',// 参与者显示值
	...
	initComponent : function() {
		...
		com.zoomlion.hjsrm.empnewComboWindow.superclass.initComponent
				.call(this);
...
com.zoomlion.hjsrm.empnewCombo = Ext.extend(Ext.form.TriggerField, {
			...
			initComponent : function() {
				...
				com.zoomlion.hjsrm.empnewCombo.superclass.initComponent
						.call(this);
			},
			onTriggerClick : function() {
				...
				this.powWindow.mon(this.powWindow, 'callback', function(pts,id) {
							this.setValue(pts);
							Ext.getCmp("bizorgidsx").setValue(id);
						}, this);
			},
			getselectWin : function() {
				return new com.zoomlion.hjsrm.empnewComboWindow({
							orgid : Ext.getCmp(orgid).getValue()
						});
			}
		})
Ext.reg('empnewCombo', com.zoomlion.hjsrm.empnewCombo);
// demo:
