 ...
 * 
 * <pre><code>
 * Examples : new com.zoomlion.hjsrm.producttree({
 * 			loader : loader
 * 		});
 * </code></pre>
 */
com.zoomlion.hjsrm.ProductTree = Ext.extend(Ext.tree.TreePanel, {
	title : '产品树',
	rootVisible : false,
	margin:5,
	useArrows : true,
	...
	initComponent : function() {
		...
		//this.buildTools();
		this.buildTbar();
		com.zoomlion.hjsrm.ProductTree.superclass.initComponent.call(this);
...
Ext.reg("producttree", com.zoomlion.hjsrm.ProductTree);