...
// Examples : new com.zoomlion.hjsrm.MatnrLoader({
// dataUrl : dataUrl
// param : undefined,//
// ifcheckbox : true,//是否有复选框
// });
com.zoomlion.hjsrm.MatnrLoader = Ext.extend(Ext.tree.TreeLoader, {
	isASyncTree : false,
	dataUrl : "com.zoomlion.hjsrm.pub.busi.common.srmcommon.queryProductTree2.biz.ext",
	param : undefined,
	ifcheckbox : false,// 是否有复选框
	constructor : function(config) {
		com.zoomlion.hjsrm.MatnrLoader.superclass.constructor.call(this,
				config);
		this.on({
					scope : this,
...
Ext.reg("matnrloader", com.zoomlion.hjsrm.MatnrLoader);
