 ...
 *          选择参与者弹出框
 */
com.zoomlion.hjsrm.matnrallComboWindow = Ext.extend(Ext.Window, {
	title : '选择物料编码',// 标题栏
	...
	initComponent : function() {
		...
		com.zoomlion.hjsrm.matnrallComboWindow.superclass.initComponent
				.call(this);
	...
	buildParticipantsList : function() {
		...
		this.participantsListPanel = new Ext.fn.ListPanel({
			...
			store : new Ext.data.JsonStore({
				url : 'com.zoomlion.hjsrm.pub.busi.common.srmcommon.querymatnrallCombo.biz.ext',
				root : 'data',
				autoLoad : false,
...
com.zoomlion.hjsrm.matnrallCombo = Ext.extend(Ext.form.TriggerField, {
			...
			initComponent : function() {
				...
				com.zoomlion.hjsrm.matnrallCombo.superclass.initComponent
						.call(this);
			},
			...
			getselectWin : function() {
				return new com.zoomlion.hjsrm.matnrallComboWindow({
						});
			}
		})
Ext.reg("matnrallCombo", com.zoomlion.hjsrm.matnrallCombo);
// demo:
