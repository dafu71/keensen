...
/**
 * 
 * @class com.zoomlion.hjsrm.selectParticipantsWindow2
 * @extends Ext.Window
 *          <p>
 *          选择参与者弹出框
 */
com.zoomlion.hjsrm.selectParticipantsWin2 = Ext.extend(Ext.Window, {
	title : '选择参与者',// 标题栏
	...
	initComponent : function() {
		...
		com.zoomlion.hjsrm.selectParticipantsWin2.superclass.initComponent
				.call(this);
	...
	buildParticipantsList : function() {
		...
		this.participantsListPanel = new Ext.fn.ListPanel({
			...
			store : new Ext.data.JsonStore({
				url : 'com.zoomlion.hjsrm.pub.busi.common.srmcommon.queryParticipantsByRoleOrOrg3.biz.ext',
				root : 'data',
...
com.zoomlion.hjsrm.selectParticipateField2 = Ext.extend(Ext.form.TriggerField, {
			...
			initComponent : function() {
				...
				com.zoomlion.hjsrm.selectParticipateField2.superclass.initComponent
						.call(this);
			},
			...
			getselectWin : function() {
				return new com.zoomlion.hjsrm.selectParticipantsWin2({
							currentRolecode : this.currentRolecode,
							currentOrgcode : this.currentOrgcode
						});
			}
		})
Ext.reg('selectParticipateField2', com.zoomlion.hjsrm.selectParticipateField2);
// demo:
