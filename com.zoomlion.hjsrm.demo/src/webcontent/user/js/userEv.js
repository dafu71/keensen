...
// 
// =================================================================
com.zoomlion.hjsrm.demo.userMgr.prototype.destroy = function() {
	this.empInputWin.destroy();
	this.empEditWin.destroy();
}
com.zoomlion.hjsrm.demo.userMgr.prototype.initEvent = function() {
 ...
 * 新增按钮处理
 */
com.zoomlion.hjsrm.demo.userMgr.prototype.onInput = function(btn, e) {
 ...
 * 注销按钮处理
 */
com.zoomlion.hjsrm.demo.userMgr.prototype.onDelete = function(btn, e) {
	// 保存this
	var me = this;
 ...
 * 恢复人员按钮点击处理
 */
com.zoomlion.hjsrm.demo.userMgr.prototype.onRegainEmp = function() {
	// 保存this
	var me = this;
	var record = this.empGridPanel.selModel.getSelections();
	var data = [];
 ...
 * 修改按钮处理
 */
com.zoomlion.hjsrm.demo.userMgr.prototype.onEdit = function() {
