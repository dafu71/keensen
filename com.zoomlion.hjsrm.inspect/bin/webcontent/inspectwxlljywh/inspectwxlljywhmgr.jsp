...
<js:load scriptPath="inspect/inspectwxlljywh/js/inspectwxlljywhUi.js"/>
<js:load scriptPath="inspect/inspectwxlljywh/js/inspectwxlljywhEv.js"/>
...
<script type="text/javascript">
  FunctionMgr.load({ 
			mainfn:com.zoomlion.hjsrm.inspect.InspectwxlljywhMgr
		});
 </script>
<title>外协来料检验记录表维护</title>
</head>
<body>
<div id="inspectwxlljywhMgr"></div>
</body>
</html>
