 ...
 * 示例event @author rye
 */
com.zoomlion.hjsrm.inspect.Inspectqjbztdmgr.prototype.destroy = function() {
	this.excelUploadWin.destroy();

}
com.zoomlion.hjsrm.inspect.Inspectqjbztdmgr.prototype.initEvent = function() {
...
// 弹出文件上传选择窗口
com.zoomlion.hjsrm.inspect.Inspectqjbztdmgr.prototype.onImportExcel = function() {
...
// 文件上传
com.zoomlion.hjsrm.inspect.Inspectqjbztdmgr.prototype.doUpload = function() {
	var _this = this;
	var store = this.listPanel.store;
...
// 模板文件下载
com.zoomlion.hjsrm.inspect.Inspectqjbztdmgr.prototype.downFile = function() {
	var fname="Inspectqjmb.xls";
