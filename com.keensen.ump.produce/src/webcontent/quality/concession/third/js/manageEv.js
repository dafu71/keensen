com.keensen.ump.produce.quality.concessionThirdMgr.prototype.initEvent = function() {
	var _this = this;
	var prodSpecId = '';
...
com.keensen.ump.produce.quality.concessionThirdMgr.prototype.onSave = function() {
	// 校验
	...
	Ext.Ajax.request({
				method : "post",
				scope : this,
				url : 'com.keensen.ump.produce.quality.concession.saveThird.biz.ext',
				jsonData : {
...
com.keensen.ump.produce.quality.concessionThirdMgr.prototype.onClose = function() {
	closeMyTab();
}
...
// 驳回
com.keensen.ump.produce.quality.concessionThirdMgr.prototype.onRefuse = function() {
	var _this = this;
...
com.keensen.ump.produce.quality.concessionThirdMgr.prototype.onCopy = function() {
