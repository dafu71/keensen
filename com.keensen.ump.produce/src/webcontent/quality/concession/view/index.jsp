...
<js:load scriptPath="produce/quality/concession/view/js/manageUi.js"/>
<js:load scriptPath="produce/quality/concession/view/js/manageEv.js"/>
...
<script type="text/javascript">
	...
	var listId = "<%=listId %>";
   FunctionMgr.load({ 
			mainfn:com.keensen.ump.produce.quality.concessionViewMgr
		});

 </script>
</head>
<body>
<div id="concessionviewmgr"></div>
</body>
</html>