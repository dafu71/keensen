...
<js:load scriptPath="produce/quality/concession/second/js/manageUi.js"/>
<js:load scriptPath="produce/quality/concession/second/js/manageEv.js"/>
...
<script type="text/javascript">
   ...
   FunctionMgr.load({ 
			mainfn:com.keensen.ump.produce.quality.concessionSencondMgr
		});

 </script>
</head>
<body>
<div id="concessionsencondmgr"></div>
</body>
</html>