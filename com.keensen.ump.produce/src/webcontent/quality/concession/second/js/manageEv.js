com.keensen.ump.produce.quality.concessionSencondMgr.prototype.initEvent = function() {
	var _this = this;
	var prodSpecId = '';
	...
	this.viewPanel.mon(this.viewPanel, 'afterload', function() {
				var recordIds = this.viewPanel.form.findField('reserve1')
						.getValue();
				var pkid = this.viewPanel.form.findField('id').getValue();
				this.inputPanel.form.findField('id').setValue(pkid);
...
com.keensen.ump.produce.quality.concessionSencondMgr.prototype.onSave = function() {
	// 校验
	...
	Ext.Ajax.request({
				method : "post",
				scope : this,
				url : 'com.keensen.ump.produce.quality.concession.saveSecond.biz.ext',
				jsonData : {
...
com.keensen.ump.produce.quality.concessionSencondMgr.prototype.onClose = function() {
	closeMyTab();
}
...
// 驳回
com.keensen.ump.produce.quality.concessionSencondMgr.prototype.onRefuse = function() {
	var _this = this;
...
com.keensen.ump.produce.quality.concessionSencondMgr.prototype.onCopy = function() {
