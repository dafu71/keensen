...
<js:load scriptPath="produce/quality/concession/fourth/js/manageUi.js"/>
<js:load scriptPath="produce/quality/concession/fourth/js/manageEv.js"/>
...
<script type="text/javascript">
   ...
   FunctionMgr.load({ 
			mainfn:com.keensen.ump.produce.quality.concessionFourthMgr
		});

 </script>
</head>
<body>
<div id="concessionfourthmgr"></div>
</body>
</html>