...
<js:load scriptPath="produce/quality/concession/sixth/js/manageUi.js"/>
<js:load scriptPath="produce/quality/concession/sixth/js/manageEv.js"/>
...
<script type="text/javascript">
   ...
   FunctionMgr.load({ 
			mainfn:com.keensen.ump.produce.quality.concessionSixthMgr
		});

 </script>
</head>
<body>
<div id="concessionsixthmgr"></div>
</body>
</html>