...
<js:load scriptPath="produce/quality/proddefect/js/defectListUi.js"/>
<js:load scriptPath="produce/quality/proddefect/js/defectListEv.js"/>
...
<script type="text/javascript">
  ...
  var opt = '';
  FunctionMgr.load({ 
			mainfn:com.keensen.ump.produce.quality.ProddefectListMgr
		});
 </script>
</head>
<body>
<div id="proddefectlistmgr"></div>
</body>
</html>