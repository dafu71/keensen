...
<js:load scriptPath="produce/quality/proddefect/js/manageUi.js"/>
<js:load scriptPath="produce/quality/proddefect/js/manageEv.js"/>
...
<script type="text/javascript">
  ...
  var opt = '';
  FunctionMgr.load({ 
			mainfn:com.keensen.ump.produce.quality.ProddefectMgr
		});
 </script>
</head>
<body>
<div id="proddefectmgr"></div>
</body>
</html>