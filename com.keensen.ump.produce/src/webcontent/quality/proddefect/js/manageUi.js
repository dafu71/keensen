com.keensen.ump.produce.quality.ProddefectMgr = function() {
	...
	this.initListPanel = function() {
		...
		this.listPanel = new Ext.fn.ListPanel({
			...
			selModel : selModel,
			delUrl : 'com.keensen.ump.produce.quality.defect.deleteProdDefect.biz.ext',
			...
			store : new Ext.data.JsonStore({
				url : 'com.keensen.ump.produce.quality.defect.queryProdDefectByPage.biz.ext',
				root : 'data',
				autoLoad : true,
	...
	this.initInputWindow = function() {
		...
		this.inputWindow = this.inputWindow || new Ext.fn.FormWindow({
			...
			items : [{
				...
				columns : 12,
				saveUrl : 'com.keensen.ump.produce.quality.defect.saveProdDefect.biz.ext',
				fields : [{
							xtype : 'combobox',
							mode : 'local',
							fieldLabel : '一级目录',
	...
	this.initEditWindow = function() {
		...
		this.editWindow = this.editWindow || new Ext.fn.FormWindow({
			...
			items : [{
				...
				pgrid : this.listPanel,
				columns : 12,
				loadUrl : 'com.keensen.ump.produce.quality.defect.expandProdDefect.biz.ext',
				saveUrl : 'com.keensen.ump.produce.quality.defect.saveProdDefect.biz.ext',
				fields : [{
							xtype : 'combobox',
							mode : 'local',
