com.keensen.ump.produce.quality.JmDefectListMgr = function() {
	...
	this.initListPanel = function() {
		...
		this.listPanel = new Ext.fn.ListPanel({
			...
			selModel : selModel,
			delUrl : 'com.keensen.ump.produce.quality.defect.deleteJmDefectList.biz.ext',
			...
			store : new Ext.data.JsonStore({
				url : 'com.keensen.ump.produce.quality.defect.queryJmDefectListByPage.biz.ext',
				root : 'data',
				autoLoad : true,
