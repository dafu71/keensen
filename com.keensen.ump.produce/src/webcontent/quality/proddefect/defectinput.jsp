...
<js:load scriptPath="produce/quality/proddefect/js/defectInputUi.js"/>
<js:load scriptPath="produce/quality/proddefect/js/defectInputEv.js"/>
...
<script type="text/javascript">
  ...
  var opt = '';
  FunctionMgr.load({ 
			mainfn:com.keensen.ump.produce.quality.ProddefectInputMgr
		});
 </script>
</head>
<body>
<div id="proddefectinputmgr"></div>
</body>
</html>