...
<js:load scriptPath="produce/quality/std/waterstd/js/manageUi.js"/>
<js:load scriptPath="produce/quality/std/waterstd/js/manageEv.js"/>
...
<script type="text/javascript">
  ...
  var mylistid = Ext.id();
  FunctionMgr.load({ 
			mainfn:com.keensen.ump.produce.quality.waterstdMgr
		});
 </script>
</head>
<body>
<div id="waterstdmgr"></div>
</body>
</html>