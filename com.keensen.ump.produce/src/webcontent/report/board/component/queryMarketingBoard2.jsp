...
.style5 {color:red;font-family: "仿宋";font-size:18pt;height: 60px;}
...
<th align='center' colspan=14 class="style6">
 ...
 <tr>
        <th width="8%" align="center" class="style5">
         订单编号
        </th> 
        <th width="7%" align="center" class="style5">
          卷膜型号
        </th>        
        <th  width="8%" align="center" class="style5">
          干/湿膜
...
<div align="center" style="height:100%;overflow-y: auto; margin-top: 1px;" id="scrollable">
...
<%
 ...
 %>
  ...
  <% } %>
    	...
    	<td width="8%" align='center' class="<%=style5 %>" style="background-color: #<%=list[i].getString("mystyle") %>" >
   		<%=list[i].getString("orderNo") %>
          
        </td>
        <td width="7%" align='center' class="<%=style5 %>" style="background-color: #<%=list[i].getString("mystyle") %>">
        ...
        <td width="7%" align='center' class="<%=style5 %>"  >
