com.keensen.ump.produce.marketing.BagMgr = function() {
	...
	this.initListPanel = function() {
		...
		this.listPanel = new Ext.fn.ListPanel({
			...
			selModel : selModel,
			delUrl : 'com.keensen.ump.produce.marketing.appearance.deleteBag.biz.ext',
			...
			store : new Ext.data.JsonStore({
				url : 'com.keensen.ump.produce.marketing.appearance.queryBagByPage.biz.ext',
				root : 'data',
				autoLoad : true,
	...
	this.initInputWindow = function() {
		...
		this.inputWindow = this.inputWindow || new Ext.fn.FormWindow({
			...
			items : [{
				...
				columns : 2,
				saveUrl : 'com.keensen.ump.produce.marketing.appearance.saveBag.biz.ext',
				fields : [{
							xtype : 'textfield',
	...
	this.initEditWindow = function() {
		this.editWindow = this.editWindow || new Ext.fn.FormWindow({
			...
			items : [{
				...
				pgrid : this.listPanel,
				columns : 2,
				loadUrl : 'com.keensen.ump.produce.marketing.appearance.expandBag.biz.ext',
				saveUrl : 'com.keensen.ump.produce.marketing.appearance.saveBag.biz.ext',
				fields : [{
							xtype : 'textfield',
							name : 'entity/bagDrawingCode',
