...
<%
    ...
    String rootUrl = request.getRequestURL().toString();
  	rootUrl = rootUrl.replace("/produce/marketing/appearance/bag/index.jsp","");
%>
<html>
<!-- 
  - Author(s): dafu
...
<js:load scriptPath="produce/marketing/appearance/bag/js/manageUi.js"/>
<js:load scriptPath="produce/marketing/appearance/bag/js/manageEv.js"/>
<script type="text/javascript">
  ...
  FunctionMgr.load({ 
			mainfn:com.keensen.ump.produce.marketing.BagMgr
		});
 </script>
