...
<js:load scriptPath="produce/marketing/appearance/sn/js/manageUi.js"/>
<js:load scriptPath="produce/marketing/appearance/sn/js/manageEv.js"/>
<script type="text/javascript">
  var uid = "<%=uid %>";
  var listid = Ext.id();
  
  FunctionMgr.load({ 
			mainfn:com.keensen.ump.produce.marketing.SnMgr
		});
 </script>
