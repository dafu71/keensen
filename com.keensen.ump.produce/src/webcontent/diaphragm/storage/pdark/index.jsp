...
<js:load scriptPath="produce/diaphragm/storage/pdark/js/manageUi.js"/>
<js:load scriptPath="produce/diaphragm/storage/pdark/js/manageEv.js"/>
<script type="text/javascript">
  var uid = "<%=uid %>";
  var listid = Ext.id();
  var currentWindow ='';
  FunctionMgr.load({ 
			mainfn:com.keensen.ump.produce.diaphragm.storage.PdarkMgr
		});
 </script>
</head>
<body>
