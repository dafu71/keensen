...
<js:load scriptPath="produce/diaphragm/storage/pdaquery/js/manageUi.js"/>
<js:load scriptPath="produce/diaphragm/storage/pdaquery/js/manageEv.js"/>
<script type="text/javascript">
  var uid = "<%=uid %>";
  var listid = Ext.id();
  var currentWindow ='';
  FunctionMgr.load({ 
			mainfn:com.keensen.ump.produce.diaphragm.storage.PdaqueryMgr
		});
 </script>
</head>
<body>
<div id="pdaquerymgr"></div>
</body>
</html>