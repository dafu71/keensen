...
<js:load scriptPath="produce/diaphragm/make/report/usedrate/js/manageUi.js"/>
<js:load scriptPath="produce/diaphragm/make/report/usedrate/js/manageEv.js"/>
...
<script type="text/javascript">
  ...
  FunctionMgr.load({ 
			mainfn:com.keensen.ump.produce.diaphragm.make.report.UsedrateMgr
		});
 </script>
</head>
<body>
<div id="makereportusedratemgr"></div>
</body>
</html>