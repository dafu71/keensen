...
<js:load scriptPath="produce/diaphragm/make/abnormal/js/manageUi.js"/>
<js:load scriptPath="produce/diaphragm/make/abnormal/js/manageEv.js"/>
...
<script type="text/javascript">
  ...
  FunctionMgr.load({ 
			mainfn:com.keensen.ump.produce.diaphragm.make.abnormalMgr
		});
 </script>
</head>
<body>
<div id="makeabnormalmgr"></div>
</body>
</html>