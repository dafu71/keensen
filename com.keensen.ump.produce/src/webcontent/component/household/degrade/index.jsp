...
<script type="text/javascript">
	BIZ.ns('com.keensen.ump.produce.component.household');
</script>
<script type="text/javascript">
...
<js:load scriptPath="produce/component/household/degrade/js/manageUi.js" />
<js:load scriptPath="produce/component/household/degrade/js/manageEv.js" />
<script type="text/javascript">
  var uid = "<%=uid %>";
  var listid = Ext.id();
  var listid3 = Ext.id();
  ...
  var opt = '';
  FunctionMgr.load({ 
			mainfn:com.keensen.ump.produce.component.household.DegradeMgr
		});
 </script>
</head>
<body>
<div id="householddegradeMgr"></div>
</body>
</html>
