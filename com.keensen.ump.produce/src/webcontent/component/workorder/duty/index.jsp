...
<js:load scriptPath="pub/common/machineCombo.js"/>
<js:load scriptPath="produce/component/workorder/duty/js/manageUi.js"/>
<js:load scriptPath="produce/component/workorder/duty/js/manageEv.js"/>
<script type="text/javascript">
...
var opt = '';
  var listid = Ext.id();
  FunctionMgr.load({ 
			mainfn:com.keensen.ump.produce.component.workorder.dutyMgr
		});
 </script>
</head>
<body>
<div id="workorderdutymgr"></div>
</body>
</html>