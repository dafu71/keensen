...
<js:load scriptPath="produce/component/workorder/jmduty/js/manageUi.js"/>
<js:load scriptPath="produce/component/workorder/jmduty/js/manageEv.js"/>
<script type="text/javascript">
  var uid = "<%=uid %>";
  var jmcodeId = Ext.id();
