...
<%
    ...
    String rootUrl = request.getRequestURL().toString();
  	rootUrl = rootUrl.replace("produce/component/yxorderrecord/input/index.jsp","");
%>
<html>
<!-- 
  - Author(s): dafu
...
<js:load scriptPath="produce/component/yxorderrecord/input/js/manageUi.js"/>
<js:load scriptPath="produce/component/yxorderrecord/input/js/manageEv.js"/>
<script type="text/javascript">
  ...
  var reviewupload = Ext.id();
  FunctionMgr.load({ 
			mainfn:com.keensen.ump.produce.component.YxorderInputMgr
		});
 </script>
</head>
<body>
<div id="yxorderinputmgr"></div>
</body>
</html>