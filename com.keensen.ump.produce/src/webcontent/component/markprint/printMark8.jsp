...
<%
	...
	String prodSpecName2 = request.getParameter("prodSpecName2").toString();
  	rootUrl = rootUrl.replace("/produce/component/markprint/printMark8.jsp","");
...
class="main_table" border=0>
   ...
   <% 
    ...
    %>
   <td colspan=4  valign="top" align="left" style="font-size: <%=fontSize %>;"><%=prodSpecName2 %></td>
   ...
   <td width="50px"></td>
   <td width="50px"></td>
   <td colspan=4 align="center" valign="bottom"><svg id="barcode_<%=prodBatchNo %>" style="width:50mm"></svg></td>
   <td width="50px"></td>
   <td width="50px"></td>   
   </tr>
