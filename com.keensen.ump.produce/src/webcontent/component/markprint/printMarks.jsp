...
<%
	...
	String rootUrl = request.getRequestURL().toString();
  	...
  	rootUrl = rootUrl.replace("/produce/component/markprint/printMarks.jsp","");
...
width="800px" height="600px" border=0>
  ...
  <tr height="80px">
	<td width="100px" ></td>
	<td colspan=4 align="center" valign="top"><svg id="barcode_<%=list[i].get("prodBatchNo") %>" style="width:80mm"></svg></td>	
	<td width="100px" ></td>
	<td width="100px" ></td>
	<td width="100px" ></td>	
  </tr>
