...
<%
	...
	String rootUrl = request.getRequestURL().toString();
  	...
  	rootUrl = rootUrl.replace("/produce/component/markprint/printMarks8.jsp","");
...
class="main_table" border=0>
   ...
   <% String prodSpecName2 = list[i].get("prodSpecName2").toString();
   	  String fontSize = prodSpecName2.length() >= 18 ? "12px"
					: prodSpecName2.length() > 9 ? "16px" : "22px";
    %>
   <td colspan=4  valign="top" align="left" style="font-size: <%=fontSize %>;"><%=list[i].get("prodSpecName2") %></td>
   ...
   <td width="50px"></td>
   <td width="50px"></td>
   <td colspan=4 align="center" valign="bottom"><svg id="barcode_<%=list[i].get("prodBatchNo") %>" style="width:50mm"></svg></td>
   <td width="50px"></td>
   <td width="50px"></td>  
