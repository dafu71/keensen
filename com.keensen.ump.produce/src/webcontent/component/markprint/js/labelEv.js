com.keensen.ump.produce.component.LabelTemplateMgr.prototype.initEvent = function() {
	var _this = this;
...
com.keensen.ump.produce.component.LabelTemplateMgr.prototype.onAdd = function() {
	this.inputWindow.show();
}

com.keensen.ump.produce.component.LabelTemplateMgr.prototype.onDelete = function() {

	this.listPanel.onDel();

}

com.keensen.ump.produce.component.LabelTemplateMgr.prototype.onEdit = function() {
	this.listPanel.onEdit();
};

com.keensen.ump.produce.component.LabelTemplateMgr.prototype.onUploadTestPicture = function() {
...
com.keensen.ump.produce.component.LabelTemplateMgr.prototype.onUploadWindowShow = function(
		o) {
...
com.keensen.ump.produce.component.LabelTemplateMgr.prototype.pretreatment = function(
		e, fileId) {
	var _this = this;
...
// 文件上传
com.keensen.ump.produce.component.LabelTemplateMgr.prototype.doUpload = function() {
	var _this = this;
	this.uploadInputPanel = this.uploadWin.getComponent('uploadForm');
	// 校验
	this.fileUploadObj = this.uploadInputPanel.form.findField("uploadFile");
...
com.keensen.ump.produce.component.LabelTemplateMgr.prototype.onSave = function() {
...
com.keensen.ump.produce.component.LabelTemplateMgr.prototype.onSave2 = function() {
...
com.keensen.ump.produce.component.LabelTemplateMgr.prototype.onView = function() {
	var A = this.listPanel;
	if (!A.getSelectionModel().getSelected()) {
		Ext.Msg.alert("系统提示", "没有选定数据，请选择数据行！");
		return;
...
com.keensen.ump.produce.component.LabelTemplateMgr.prototype.onChoose4Label = function() {
...
com.keensen.ump.produce.component.LabelTemplateMgr.prototype.onAddLable = function() {
	this.inputWindow4ChooseLable.form.reset();
	this.inputWindow4ChooseLable.show();
};

com.keensen.ump.produce.component.LabelTemplateMgr.prototype.saveLabel = function(
...
com.keensen.ump.produce.component.LabelTemplateMgr.prototype.onDelLable = function() {
...
com.keensen.ump.produce.component.LabelTemplateMgr.prototype.onUploadWindowShow4ChooseLable = function() {
...
// 文件上传
com.keensen.ump.produce.component.LabelTemplateMgr.prototype.doUpload4ChooseLable = function() {
	var _this = this;
...
com.keensen.ump.produce.component.LabelTemplateMgr.prototype.onPreView = function() {
	var A = this.listPanel;
	if (!A.getSelectionModel().getSelected()) {
		Ext.Msg.alert("系统提示", "没有选定数据，请选择数据行！");
		return;
...
com.keensen.ump.produce.component.LabelTemplateMgr.prototype.onModifyLableUrl = function() {
...
com.keensen.ump.produce.component.LabelTemplateMgr.prototype.onModiParam = function() {
	var A = this.listPanel;
	var _this = this;
	if (!A.getSelectionModel().getSelected()) {
		Ext.Msg.alert("系统提示", "没有选定数据，请选择数据行！");
...
com.keensen.ump.produce.component.LabelTemplateMgr.prototype.onChangeStatus = function() {
	var A = this.listPanel;
	var _this = this;
	if (!A.getSelectionModel().getSelected()) {
		Ext.Msg.alert("系统提示", "没有选定数据，请选择数据行！");
		...
		this.requestMask.show();
		Ext.Ajax.request({
			url : "com.keensen.ump.produce.component.makprint.saveBatchStatus.biz.ext",
			method : "post",
			jsonData : {
				ids : ids.join(',')
...
com.keensen.ump.produce.component.LabelTemplateMgr.prototype.onChangeLabelStatus = function() {
	var A = this.listPanel4ChooseLable;
	var _this = this;
	if (!A.getSelectionModel().getSelected()) {
		Ext.Msg.alert("系统提示", "没有选定数据，请选择数据行！");
		...
		this.requestMask.show();
		Ext.Ajax.request({
			url : "com.keensen.ump.produce.component.makprint.saveBatchLabelStatus.biz.ext",
			method : "post",
			jsonData : {
				ids : ids.join(',')
