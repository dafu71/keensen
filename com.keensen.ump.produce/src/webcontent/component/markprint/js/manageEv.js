...
com.keensen.ump.produce.component.markprinttemplateMgr.prototype.onChangeStatus = function() {
	var A = this.listPanel;
	var _this = this;
	if (!A.getSelectionModel().getSelected()) {
		Ext.Msg.alert("系统提示", "没有选定数据，请选择数据行！");
...
com.keensen.ump.produce.component.markprinttemplateMgr.prototype.onChangeLabelStatus = function() {
	var A = this.listPanel4ChooseLable;
	var _this = this;
	if (!A.getSelectionModel().getSelected()) {
		Ext.Msg.alert("系统提示", "没有选定数据，请选择数据行！");
