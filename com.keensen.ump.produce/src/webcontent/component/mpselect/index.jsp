...
<js:load scriptPath="produce/component/mpselect/js/manageUi.js"/>
<js:load scriptPath="produce/component/mpselect/js/manageEv.js"/>
<script type="text/javascript">
...
var params = [];
  ...
  FunctionMgr.load({ 
			mainfn:com.keensen.ump.produce.component.mpselectMgr
		});
 </script>
</head>
<body>
<div id="mpselectmgr"></div>
</body>
</html>