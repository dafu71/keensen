...
<js:load scriptPath="produce/component/interactive/js/manageEv.js"/>
<script type="text/javascript">
...
var params = [];
  ...
  FunctionMgr.load({ 
			mainfn:com.keensen.ump.produce.component.InteractiveSelectMgr
		});
 </script>
</head>
<body>
<div id="interactiveselectmgr"></div>
</body>
</html>