...
<js:load scriptPath="produce/component/prodrecord/js/reworkUi.js"/>
<js:load scriptPath="produce/component/prodrecord/js/reworkEv.js"/>
<script type="text/javascript">
  var uid = "<%=uid %>";
  ...
  FunctionMgr.load({ 
			mainfn:com.keensen.ump.produce.component.ReworkResultMgr
		});
 </script>
</head>
<body>
<div id="reworkresultmgr"></div>
