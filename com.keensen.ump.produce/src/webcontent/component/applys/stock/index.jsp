...
<js:load scriptPath="produce/component/applys/stock/js/manageUi.js"/>
<js:load scriptPath="produce/component/applys/stock/js/manageEv.js"/>
<script type="text/javascript">
  var uid = "<%=uid %>";
  FunctionMgr.load({ 
			mainfn:com.keensen.ump.produce.component.applys.stockMgr
		});
 </script>
</head>
<body>
<div id="applysstockmgr"></div>
</body>
</html>