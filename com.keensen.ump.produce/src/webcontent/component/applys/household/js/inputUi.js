com.keensen.ump.produce.component.applys.ApplyDeliveryConfirmMgr = function() {
	...
	this.initPanel = function() {
		...
		return new Ext.fn.fnLayOut({
					...
					border : false,
					border : false,
					renderTo : 'applysapplydeliveryconfirmmgr',
	...
	this.initInputWindow = function() {
		...
		this.listPanel = new Ext.fn.ListPanel({
			...
			// autoExpandColumn : '4',
			delUrl : 'com.keensen.ump.produce.component.applys.cancelDeliveryConfirm.biz.ext',
			hsPage : true,
			tbar : [{
						text : '删除',
						scope : this,
