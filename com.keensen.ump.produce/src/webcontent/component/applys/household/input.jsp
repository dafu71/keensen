...
<js:load scriptPath="produce/component/applys/household/js/inputUi.js" />
<js:load scriptPath="produce/component/applys/household/js/inputEv.js" />
<script type="text/javascript">
  var uid = "<%=uid %>";
  var listid = Ext.id();
  var listid3 = Ext.id();
  ...
  var opt = '';
  FunctionMgr.load({ 
			mainfn:com.keensen.ump.produce.component.applys.ApplyDeliveryConfirmMgr
		});
 </script>
</head>
<body>
<div id="applysapplydeliveryconfirmmgr"></div>
</body>
</html>
