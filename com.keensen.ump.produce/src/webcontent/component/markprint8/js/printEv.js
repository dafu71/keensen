com.keensen.ump.produce.component.markprint8Mgr.prototype.initEvent = function() {
...
// 扫码
com.keensen.ump.produce.component.markprint8Mgr.prototype.onScan = function() {
	var _this = this;
	...
	Ext.Ajax.request({
		...
		success : function(response, action) {
			...
			if (result.msg != 1) {
				...
				if (!isRecord) {
					var f = document.getElementById('componentmarkprint8Form');
...
com.keensen.ump.produce.component.markprint8Mgr.prototype.destroy = function() {
	// this.editWindow.destroy();
	this.inputWindow.destroy();
}

com.keensen.ump.produce.component.markprint8Mgr.prototype.onReset = function() {
	this.inputPanel.form.reset();
	this.inputPanel.prodBatchNo.focus(false, 100);
}

com.keensen.ump.produce.component.markprint8Mgr.prototype.onDuty = function() {
	var A = {};
	A.data = {
		id : 1
	};
