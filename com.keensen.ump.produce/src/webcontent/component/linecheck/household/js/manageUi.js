com.keensen.ump.produce.component.linecheck.HouseholdMgr = function() {
	...
	this.initPanel = function() {
		...
		return new Ext.fn.fnLayOut({
					...
					border : false,
					border : false,
					renderTo : 'linecheckhouseholdmgr',
	...
	this.initEditPanel = function() {
		...
		this.editPanel = this.editPanel || new Ext.fn.EditPanel({
			...
			baseCls : "x-plain",
			border : true,
			saveUrl : 'com.keensen.ump.produce.component.linecheck.saveHHCheck.biz.ext',
			loadUrl : 'com.keensen.ump.produce.component.linecheck.expandHHCheckJudge.biz.ext',
			fields : [{
						xtype : 'displayfield',
