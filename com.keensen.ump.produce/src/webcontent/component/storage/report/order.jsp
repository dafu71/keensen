...
<js:load scriptPath="produce/component/storage/report/js/orderUi.js" />
<js:load scriptPath="produce/component/storage/report/js/orderEv.js" />
<script type="text/javascript">
  var uid = "<%=uid %>";
  var listid = Ext.id();
  var listid3 = Ext.id();
  
  var orderAmountTotalId = Ext.id();
  ...
  var opt = '';
  FunctionMgr.load({ 
			mainfn:com.keensen.ump.produce.component.storage.Report4OrderMgr
		});
 </script>
</head>
<body>
<div id="report4ordermgr"></div>
</body>
</html>
