...
<js:load scriptPath="produce/component/storage/allocate/js/manageUi.js" />
<js:load scriptPath="produce/component/storage/allocate/js/manageEv.js" />
<script type="text/javascript">
  var uid = "<%=uid %>";
  var listid = Ext.id();
  var listid3 = Ext.id();
  ...
  var opt = '';
  FunctionMgr.load({ 
			mainfn:com.keensen.ump.produce.component.storage.AllocateListMgr
		});
 </script>
</head>
<body>
<div id="storageallocatelistmgr"></div>
</body>
</html>
