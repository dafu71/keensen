...
<js:load scriptPath="produce/component/storage/pda/outofstock/js/listUi.js" />
<js:load scriptPath="produce/component/storage/pda/outofstock/js/listEv.js" />
<script type="text/javascript">
  var uid = "<%=uid %>";
  var listid = Ext.id();
  var listid3 = Ext.id();
  ...
  var opt = '';
  FunctionMgr.load({ 
			mainfn:com.keensen.ump.produce.component.storage.OutOfStockListMgr
		});
 </script>
</head>
<body>
<div id="storageoutofstocklistmgr"></div>
</body>
</html>
