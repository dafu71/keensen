...
<js:load scriptPath="produce/component/produce/cut/js/manageUi.js"/>
<js:load scriptPath="produce/component/produce/cut/js/manageEv.js"/>
<script type="text/javascript">
...
var opt = '';
  var listid = Ext.id();
  FunctionMgr.load({ 
			mainfn:com.keensen.ump.produce.component.produce.CutMgr
		});
 </script>
</head>
<body>
<div id="componentproducecutmgr"></div>

<div style="display: none">
<form name="printForm" id="cutprintForm" action="" target="_blank" method="post" accept-charset="UTF-8">
