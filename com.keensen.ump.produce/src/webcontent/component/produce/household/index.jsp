...
<js:load scriptPath="produce/component/produce/household/js/manageUi.js"/>
<js:load scriptPath="produce/component/produce/household/js/manageEv.js"/>
<script type="text/javascript">
...
var opt = '';
  var listid = Ext.id();
  FunctionMgr.load({ 
			mainfn:com.keensen.ump.produce.component.produce.HouseholdMgr
		});
 </script>
</head>
<body>
<div id="componenthouseholdmgr"></div>
