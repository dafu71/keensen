com.keensen.ump.produce.component.yxorderbaseMgr = function() {
	...
	this.initAddOrderWindow = function() {
		...
		this.addOrderWindow = this.addOrderWindow || new Ext.fn.FormWindow({
			title : '生产计划录入<font style="color:red;">(输入正确的卷膜型号，单击旁边按钮，系统加载对应的生产规格及相关标准)</font>',
			height : 600,
			width : 1024,
			autoScroll : true,
			resizable : true,
			...
			items : [{
				...
				fields : [{
					...
					xtype : 'displayfield',
					value : '<p style="color:red;">单击旁边按钮计算发库存膜元件数量</p>',
					labelSeparator : '',// 去掉冒号
					colspan : 6
				}, {
					xtype : 'displayfield',
					...
					listeners : {
						...
						, {
							 ...
							 * 'local', fieldLabel : '水流箭头', ref :
							 * '../../waterArrow', hiddenName :
							 * 'entity/waterArrow', dataIndex : 'waterArrow',
							 ...
							 * hidden : true, // allowBlank : false, mode :
							 * 'local', fieldLabel : '要NSF标识', ref :
							 * '../../markNsf', hiddenName : 'entity/markNsf',
							 * dataIndex : 'markNsf', anchor : '100%', colspan :
							 * 6, emptyText : '--请选择--', editable : false, store :
							 * this.ynStore, displayField : "name", valueField :
							 * "code", listeners : { "expand" : function(A) {
							 * this.reset() } } }
