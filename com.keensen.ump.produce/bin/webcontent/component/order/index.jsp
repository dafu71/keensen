...
<js:load scriptPath="produce/component/order/js/manageUi.js"/>
<js:load scriptPath="produce/component/order/js/manageEv.js"/>
<script type="text/javascript">
  var uid = "<%=uid %>";
...
var operatorname = "<%=operatorname%>";
  var listid = Ext.id();
  FunctionMgr.load({ 
			mainfn:com.keensen.ump.produce.component.OrderMgr
		});
 </script>
</head>
<body>
<div id="componentordermgr"></div>
</body>
</html>