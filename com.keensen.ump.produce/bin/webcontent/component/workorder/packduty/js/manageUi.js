com.keensen.ump.produce.component.workorder.PackdutyMgr = function() {
	this.initPanel = function() {

		this.rec = {};
		this.rec2 = {};

		this.defaultPackCode = '';
	...
	this.initListPanel = function() {
		...
		this.listPanel = new Ext.fn.ListPanel({
			...
			delUrl : 'com.keensen.ump.produce.component.workorder2.deletePackDuty.biz.ext',
			selModel : selModel,
			columns : [new Ext.grid.RowNumberer(), selModel, {
						...
						dataIndex : 'packStateName',
						header : '作业状态'
					}],
			store : new Ext.data.JsonStore({
				url : 'com.keensen.ump.produce.component.workorder2.query4PackDutyByPage.biz.ext',
				root : 'data',
				autoLoad : true,
	...
	this.initEditWindow = function() {
		...
		this.editWindow = this.editWindow || new Ext.fn.FormWindow({
			...
			items : [{
				...
				columns : 1,
				loadUrl : 'com.keensen.ump.produce.component.workorder2.expandPackDuty.biz.ext',
				saveUrl : 'com.keensen.ump.produce.component.workorder2.savePackDuty.biz.ext',
				fields : [{
							xtype : 'trigger',
							name : 'entity/packCode',
							fieldLabel : '包装机台',
							allowBlank : false,
							emptyText : '单击旁边按钮选择机台',
							editable : false,
