com.keensen.ump.produce.component.applys.applyMgr = function() {
	...
	this.initPanel = function() {
		...
		this.initChooseMarkPrintWindow();
	...
	this.initChooseMarkPrintWindow = function() {

		var chooseMarkPrintSelModel = new Ext.grid.CheckboxSelectionModel({
					singleSelect : false
				});

		this.chooseMarkPrintListPanel = this.chooseMarkPrintListPanel
				|| new Ext.fn.ListPanel({
					region : 'center',
					viewConfig : {
						forceFit : false
					...
					tbar : [{
								...
								scope : this,
								iconCls : 'icon-application_add',
								handler : this.chooseMarkPrintOk
							}],
					hsPage : true,
					selModel : chooseMarkPrintSelModel,
					delUrl : '1.biz.ext',
					columns : [new Ext.grid.RowNumberer(),
							chooseMarkPrintSelModel, {
								dataIndex : 'batchNo',
								width : 200,
								header : '箱唛批号'
							}, {
		...
		this.queryChooseMarkPrintPanel = this.queryChooseMarkPrintPanel
				|| new Ext.fn.QueryPanel({
							height : 80,
							columns : 2,
							border : true,
		...
		this.queryChooseMarkPrintPanel.addButton({
					text : "关闭",
					scope : this,
					handler : function() {
		...
		this.chooseMarkPrintWindow = this.chooseMarkPrintWindow
				|| new Ext.Window({
							title : '箱唛查询',
							projectId : '',
							resizable : true,
							...
							height : 600,
							layout : 'border',
							items : [this.queryChooseMarkPrintPanel,
									this.chooseMarkPrintListPanel]
