	...
	this.initEditWindow = function() {
		...
		this.editPanel = this.editPanel || new Ext.fn.EditPanel({
			...
			fields : [{
						 ...
						 * hiddenName : 'entity/markIsok', allowBlank : false,
						 * fieldLabel : '包装箱唛头', dictData : KS_YESORNO, anchor :
						 * '95%', emptyText : "是否合格", colspan : 3 }, { xtype :
						 * 'dictcombobox', dataIndex : 'labelIsok', hiddenName :
						 * 'entity/labelIsok', allowBlank : false, fieldLabel :
						 * '元件标签', dictData : KS_YESORNO, anchor : '95%',
						 * emptyText : "是否合格", colspan : 3 }, { xtype :
						 * 'dictcombobox', dataIndex : 'apperanceIsok',
						 * hiddenName : 'entity/apperanceIsok', allowBlank :
						 * false, fieldLabel : '元件外观', dictData : KS_YESORNO,
						 * anchor : '95%', emptyText : "是否合格", colspan : 3 }, {
						 * xtype : 'dictcombobox', dataIndex : 'diameter',
						 * hiddenName : 'entity/diameter', allowBlank : false,
						 * fieldLabel : '元件直径', dictData : KS_YESORNO, anchor :
						 * '95%', emptyText : "是否合格", colspan : 3 }, { xtype :
