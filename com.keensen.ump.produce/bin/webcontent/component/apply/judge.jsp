...
<js:load scriptPath="produce/component/apply/js/judgeUi.js" />
<js:load scriptPath="produce/component/apply/js/judgeEv.js" />
<script type="text/javascript">
  var uid = "<%=uid %>";
  var listid = Ext.id();
  var listid3 = Ext.id();
  ...
  var opt = '';
  FunctionMgr.load({ 
			mainfn:com.keensen.ump.produce.component.ApplyJudgeMgr
		});
 </script>
</head>
<body>
<div id="applyjudgemgr"></div>
</body>
</html>
