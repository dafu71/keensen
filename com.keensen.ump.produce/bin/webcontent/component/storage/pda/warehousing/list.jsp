...
<js:load scriptPath="produce/component/storage/pda/warehousing/js/listUi.js" />
<js:load scriptPath="produce/component/storage/pda/warehousing/js/listEv.js" />
<script type="text/javascript">
  var uid = "<%=uid %>";
  var listid = Ext.id();
  var listid3 = Ext.id();
  ...
  var opt = '';
  FunctionMgr.load({ 
			mainfn:com.keensen.ump.produce.component.storage.WareHousingListMgr
		});
 </script>
</head>
<body>
<div id="storagewarehousinglistmgr"></div>
</body>
</html>
