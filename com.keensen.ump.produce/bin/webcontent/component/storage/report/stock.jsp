...
<js:load scriptPath="produce/component/storage/report/js/stockUi.js" />
<js:load scriptPath="produce/component/storage/report/js/stockEv.js" />
<script type="text/javascript">
  var uid = "<%=uid %>";
  var listid = Ext.id();
  var listid3 = Ext.id();
  ...
  var opt = '';
  FunctionMgr.load({ 
			mainfn:com.keensen.ump.produce.component.storage.Report4StockMgr
		});
 </script>
</head>
<body>
<div id="report4stockmgr"></div>
</body>
</html>
