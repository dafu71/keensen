...
<js:load scriptPath="produce/component/yxorderbase/js/manageUi5.js"/>
<js:load scriptPath="produce/component/yxorderbase/js/manageEv5.js"/>
...
var markRootUrl = "<%=rootUrl %>";
  ...
  var opt = '';
  FunctionMgr.load({ 
			mainfn:com.keensen.ump.produce.component.yxorderbaseMgr5
		});
 </script>
</head>
<body>
<div id="yxorderbasemgr5"></div>
