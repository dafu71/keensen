...
<%
    ...
    String userIP = userObject.getUserRemoteIP();
...
<js:load scriptPath="produce/component/produce/trim/js/manageUi.js"/>
<js:load scriptPath="produce/component/produce/trim/js/manageEv.js"/>
<script type="text/javascript">
...
var addTrimBtn = Ext.id();

var opt = '';
  var listid = Ext.id();
  FunctionMgr.load({ 
			mainfn:com.keensen.ump.produce.component.produce.TrimMgr
		});
 </script>
</head>
<body>
<div id="componentproducetrimmgr"></div>
