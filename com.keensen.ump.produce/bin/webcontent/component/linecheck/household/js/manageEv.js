com.keensen.ump.produce.component.linecheck.HouseholdMgr.prototype.initEvent = function() {
...
// 拍照查看
com.keensen.ump.produce.component.linecheck.HouseholdMgr.prototype.viewPhotos = function() {
...
com.keensen.ump.produce.component.linecheck.HouseholdMgr.prototype.onSave = function() {
	if (this.editPanel.form.isValid()) {
		this.editPanel.saveData();
	}
}

com.keensen.ump.produce.component.linecheck.HouseholdMgr.prototype.onViewCheckPhotos = function() {
...
com.keensen.ump.produce.component.linecheck.HouseholdMgr.prototype.uploadCheckPhotos = function(
		checkId) {
	var _this = this;
	...
	var src = markRootUrl + 'produce/component/linecheck/household/uploadHHCheckPhotos.jsp?uploadwin=linecheckhouseholdmgrphotowin&' + 
	'checkId='+checkId;

	var win = new Ext.Window({
		title : '多文件上传',
		id:'linecheckhouseholdmgrphotowin',
		width : 600,
		height : 480,
		layout : 'fit',
		resizable : false,
