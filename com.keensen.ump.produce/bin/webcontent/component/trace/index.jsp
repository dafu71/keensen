...
<js:load scriptPath="produce/component/trace/js/manageUi.js"/>
<js:load scriptPath="produce/component/trace/js/manageEv.js"/>
<script type="text/javascript">
  var uid = "<%=uid %>";
  var listid = Ext.id();
  
  FunctionMgr.load({ 
			mainfn:com.keensen.ump.produce.component.TraceMgr
		});
 </script>
