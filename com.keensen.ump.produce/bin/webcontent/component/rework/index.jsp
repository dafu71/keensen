...
<js:load scriptPath="produce/component/rework/js/manageUi.js"/>
<js:load scriptPath="produce/component/rework/js/manageEv.js"/>
<script type="text/javascript">
...
var opt = '';
  var listid = Ext.id();
  FunctionMgr.load({ 
			mainfn:com.keensen.ump.produce.component.reworkMgr
		});
 </script>
</head>
<body>
<div id="componentreworkmgr"></div>
</body>
</html>