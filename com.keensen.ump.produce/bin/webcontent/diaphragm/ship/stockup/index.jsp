...
<js:load scriptPath="produce/diaphragm/ship/stockup/js/manageUi.js"/>
<js:load scriptPath="produce/diaphragm/ship/stockup/js/manageEv.js"/>
...
<script type="text/javascript">
  ...
  <% } %>
	...
	var checkCountId = 'diaphragmshipstockupmgr' + Ext.id();
	
  FunctionMgr.load({ 
			mainfn:com.keensen.ump.produce.diaphragm.ship.StockupMgr
		});

 </script>
</head>
<body>
<div id="diaphragmshipstockupmgr"></div>
</body>
</html>