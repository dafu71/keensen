...
<js:load scriptPath="produce/diaphragm/storage/rkdrk/js/manageUi.js"/>
<js:load scriptPath="produce/diaphragm/storage/rkdrk/js/manageEv.js"/>
...
<script type="text/javascript">
  ...
  FunctionMgr.load({ 
			mainfn:com.keensen.ump.produce.diaphragm.storage.StorageRkdrkMgr
		});
 </script>
</head>
<body>
<div id="storagerkdrkmgr"></div>
</body>
</html>