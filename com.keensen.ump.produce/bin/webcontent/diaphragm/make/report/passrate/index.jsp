...
<js:load scriptPath="produce/diaphragm/make/report/passrate/js/manageUi.js"/>
<js:load scriptPath="produce/diaphragm/make/report/passrate/js/manageEv.js"/>
...
<script type="text/javascript">
  ...
  FunctionMgr.load({ 
			mainfn:com.keensen.ump.produce.diaphragm.make.report.PassrateMgr
		});
 </script>
</head>
<body>
<div id="makereportpassratemgr"></div>
</body>
</html>