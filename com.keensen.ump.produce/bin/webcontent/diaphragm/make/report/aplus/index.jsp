...
<js:load scriptPath="produce/diaphragm/make/report/aplus/js/manageUi.js"/>
<js:load scriptPath="produce/diaphragm/make/report/aplus/js/manageEv.js"/>
...
<script type="text/javascript">
  ...
  FunctionMgr.load({ 
			mainfn:com.keensen.ump.produce.diaphragm.make.report.APlusMgr
		});
 </script>
</head>
<body>
