...
<js:load scriptPath="produce/quality/tumo/js/manageUi.js"/>
<js:load scriptPath="produce/quality/tumo/js/manageEv.js"/>
...
<script type="text/javascript">
  var uid = "<%=uid %>";
  var listid = 'ship-choose-list';
  FunctionMgr.load({ 
			mainfn:com.keensen.ump.produce.quality.tumoMgr
		});
 </script>
</head>
<body>
