...
<js:load scriptPath="produce/quality/concession/eighth/js/manageUi.js"/>
<js:load scriptPath="produce/quality/concession/eighth/js/manageEv.js"/>
...
<script type="text/javascript">
   ...
   FunctionMgr.load({ 
			mainfn:com.keensen.ump.produce.quality.concessionEighthMgr
		});

 </script>
</head>
<body>
<div id="concessionEighthmgr"></div>
</body>
</html>