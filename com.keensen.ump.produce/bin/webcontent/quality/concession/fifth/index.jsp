...
<js:load scriptPath="produce/quality/concession/fifth/js/manageUi.js"/>
<js:load scriptPath="produce/quality/concession/fifth/js/manageEv.js"/>
...
<script type="text/javascript">
   ...
   FunctionMgr.load({ 
			mainfn:com.keensen.ump.produce.quality.concessionFifthMgr
		});

 </script>
</head>
<body>
<div id="concessionfifthmgr"></div>
</body>
</html>