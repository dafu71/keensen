com.keensen.ump.produce.quality.concessionSeventhMgr.prototype.initEvent = function() {
	var _this = this;
	var prodSpecId = '';
...
com.keensen.ump.produce.quality.concessionSeventhMgr.prototype.onSave = function() {
	// 校验
	...
	Ext.Ajax.request({
				method : "post",
				scope : this,
				url : 'com.keensen.ump.produce.quality.concession.saveSeventh.biz.ext',
				jsonData : {
...
com.keensen.ump.produce.quality.concessionSeventhMgr.prototype.onClose = function() {
	closeMyTab();
}
