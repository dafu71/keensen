com.keensen.ump.produce.quality.concessionSixthMgr.prototype.initEvent = function() {
	var _this = this;
	var prodSpecId = '';
...
com.keensen.ump.produce.quality.concessionSixthMgr.prototype.onSave = function() {
	// 校验
	...
	Ext.Ajax.request({
				method : "post",
				scope : this,
				url : 'com.keensen.ump.produce.quality.concession.saveSixth.biz.ext',
				jsonData : {
...
com.keensen.ump.produce.quality.concessionSixthMgr.prototype.onClose = function() {
	closeMyTab();
}
...
com.keensen.ump.produce.quality.concessionSixthMgr.prototype.onCopy = function() {
