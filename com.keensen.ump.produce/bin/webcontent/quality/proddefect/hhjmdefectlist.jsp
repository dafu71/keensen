...
<js:load scriptPath="produce/quality/proddefect/js/hhjmDefectListUi.js"/>
<js:load scriptPath="produce/quality/proddefect/js/hhjmDefectListEv.js"/>
...
<script type="text/javascript">
  ...
  var batchNo4Search = "<%=batchNo  %>";
  var iftear4Search = "<%=iftear  %>";
 
  var opt = '';
  FunctionMgr.load({ 
			mainfn:com.keensen.ump.produce.quality.HHJmDefectListMgr
		});
 </script>
</head>
<body>
<div id="hhjmdefectlistmgr"></div>
</body>
</html>