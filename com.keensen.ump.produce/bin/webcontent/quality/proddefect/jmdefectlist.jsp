...
<%
    ...
    String jmBatchNo = request.getParameter("jmBatchNo");
...
<js:load scriptPath="produce/quality/proddefect/js/jmDefectListUi.js"/>
<js:load scriptPath="produce/quality/proddefect/js/jmDefectListEv.js"/>
...
<script type="text/javascript">
  ...
  var jmBatchNo4Search = "<%=jmBatchNo  %>";
  var iftear4Search = "<%=iftear  %>";
 
  var opt = '';
  FunctionMgr.load({ 
			mainfn:com.keensen.ump.produce.quality.JmDefectListMgr
		});
 </script>
</head>
<body>
<div id="jmdefectlistmgr"></div>
</body>
</html>