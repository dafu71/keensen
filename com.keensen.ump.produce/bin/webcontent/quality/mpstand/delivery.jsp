...
<js:load scriptPath="produce/quality/mpstand/js/deliveryUi.js"/>
<js:load scriptPath="produce/quality/mpstand/js/deliveryEv.js"/>
...
<script type="text/javascript">
  ...
  var opt = '';
  FunctionMgr.load({ 
			mainfn:com.keensen.ump.produce.quality.DeliverStdMgr
		});
 </script>
</head>
<body>
<div id="deliverstdmgr"></div>
</body>
</html>