com.keensen.ump.produce.quality.deliveryrecordMgr.prototype.initEvent = function() {
	...
	this.listPanel.mon(this.listPanel, 'update', function(gird, cell) {
				...
				var arr = ["entity/solution2", "entity/temperature2",
						...
						"entity/desalinationCheck2Num", "entity/waterCheck2Num"
						, "entity/pressWork2"
						, "entity/rangePh2"
						, "entity/rangeRunPh2"
						, "entity/area2"];
...
com.keensen.ump.produce.quality.deliveryrecordMgr.prototype.onStand = function() {
	...
	var client = this.inputWindow.form.findField("entity/client").getValue();
	var _this = this;
				...
				success : function(resp) {
					...
					if (ret.success) {
						...
						if (Ext.isEmpty(data) || Ext.isEmpty(data[0])
							...
							var stdStr = data[0].airStdStr;
							_this.inputWindow.form
									.findField("entity/airStdStr")
									.setValue(stdStr);

							var pressWork = data[0].pressWork;
							_this.inputWindow.form
									.findField("entity/pressWork")
									.setValue(pressWork);

							var rangePh = data[0].rangePh;
							_this.inputWindow.form.findField("entity/rangePh")
									.setValue(rangePh);

							var rangeRunPh = data[0].rangeRunPh;
							_this.inputWindow.form
									.findField("entity/rangeRunPh")
									.setValue(rangeRunPh);

							var area = data[0].area;
							_this.inputWindow.form.findField("entity/area")
									.setValue(area);
							...
							if (productName == '纳滤膜元件') {
								...
								var pressWork2 = data[0].pressWork2;
								_this.inputWindow.form
										.findField("entity/pressWork2")
										.setValue(pressWork2);

								var rangePh2 = data[0].rangePh2;
								_this.inputWindow.form
										.findField("entity/rangePh2")
										.setValue(rangePh2);

								var rangeRunPh2 = data[0].rangeRunPh2;
								_this.inputWindow.form
										.findField("entity/rangeRunPh2")
										.setValue(rangeRunPh2);

								var area2 = data[0].area2;
								_this.inputWindow.form
										.findField("entity/area2")
										.setValue(area2);
							}
						}
...
com.keensen.ump.produce.quality.deliveryrecordMgr.prototype.onStand2 = function() {
	...
	var client = this.editWindow.form.findField("entity/client").getValue();
					...
					if (ret.success) {
						...
						if (Ext.isEmpty(data) || Ext.isEmpty(data[0])
							...
							_this.editWindow.form
									...
									.setValue(desalination);
							var stdStr = data[0].airStdStr;
							_this.editWindow.form.findField("entity/airStdStr")
									.setValue(stdStr);

							var pressWork = data[0].pressWork;
							_this.editWindow.form.findField("entity/pressWork")
									.setValue(pressWork);

							var rangePh = data[0].rangePh;
							_this.editWindow.form.findField("entity/rangePh")
									.setValue(rangePh);
							...
							var area = data[0].area;
							_this.editWindow.form.findField("entity/area")
									.setValue(area);
							...
							if (productName == '纳滤膜元件') {
								...
								var area2 = data[0].area2;
								_this.editWindow.form.findField("entity/area2")
										.setValue(area2);
...
com.keensen.ump.produce.quality.deliveryrecordMgr.prototype.onAdd = function() {
	...
	this.inputWindow.form.findField('entity/desalinationResult2')
			.setValue('合格');
	this.inputWindow.form.findField('entity/airResult').setValue('合格');
...
com.keensen.ump.produce.quality.deliveryrecordMgr.prototype.onView3 = function() {
	var A = this.listPanel;
	if (!A.getSelectionModel().getSelected()) {
		Ext.Msg.alert("系统提示", "没有选定数据，请选择数据行！")
	} else {
		...
		var productName = r.data.productName;
		window.open(
				'com.keensen.ump.produce.quality.deliveryreport22.flow?opt=view&entity/id='
						+ id, "top");
...
com.keensen.ump.produce.quality.deliveryrecordMgr.prototype.onView3e = function() {
	var A = this.listPanel;
	if (!A.getSelectionModel().getSelected()) {
		Ext.Msg.alert("系统提示", "没有选定数据，请选择数据行！")
	} else {
		...
		var productName = r.data.productName;
		window.open(
				'com.keensen.ump.produce.quality.deliveryreport22e.flow?opt=view&entity/id='
						+ id, "top");
...
com.keensen.ump.produce.quality.deliveryrecordMgr.prototype.onPrint3 = function() {
	var A = this.listPanel;
	if (!A.getSelectionModel().getSelected()) {
		Ext.Msg.alert("系统提示", "没有选定数据，请选择数据行！")
	} else {
		...
		var productName = r.data.productName;
		window.open(
				'com.keensen.ump.produce.quality.deliveryreport22.flow?opt=print&entity/id='
						+ id, "top");
...
com.keensen.ump.produce.quality.deliveryrecordMgr.prototype.onPrint3e = function() {
	var A = this.listPanel;
	if (!A.getSelectionModel().getSelected()) {
		Ext.Msg.alert("系统提示", "没有选定数据，请选择数据行！")
	} else {
		...
		var productName = r.data.productName;
		window.open(
				'com.keensen.ump.produce.quality.deliveryreport22e.flow?opt=print&entity/id='
						+ id, "top");
...
com.keensen.ump.produce.quality.deliveryrecordMgr.prototype.onView4 = function() {
	var A = this.listPanel;
	if (!A.getSelectionModel().getSelected()) {
		Ext.Msg.alert("系统提示", "没有选定数据，请选择数据行！")
	} else {
		...
		window
				.open(
						'com.keensen.ump.produce.quality.deliveryreport2.flow?opt=view&type=e&entity/id='
								+ id, "top");
...
com.keensen.ump.produce.quality.deliveryrecordMgr.prototype.onPrint4 = function() {
	var A = this.listPanel;
	if (!A.getSelectionModel().getSelected()) {
		Ext.Msg.alert("系统提示", "没有选定数据，请选择数据行！")
	} else {
		...
		window
				.open(
						'com.keensen.ump.produce.quality.deliveryreport2.flow?opt=print&type=e&entity/id='
								+ id, "top");
...
com.keensen.ump.produce.quality.deliveryrecordMgr.prototype.onDown3 = function() {

	var fname = "ks_quality_delivery_list_import3.xls";
	window.location.href = "com.zoomlion.hjsrm.pub.file.excelutil.modelDownload.flow?fileName="
			+ fname;
}

com.keensen.ump.produce.quality.deliveryrecordMgr.prototype.onImport = function(
		v) {
	var A = this.listPanel;
	if (!A.getSelectionModel().getSelected()) {
		Ext.Msg.alert("系统提示", "没有选定数据，请选择数据行！")
...
com.keensen.ump.produce.quality.deliveryrecordMgr.prototype.doUpload = function() {
	...
	if (this.uploadInputPanel.form.isValid()) {
		...
		var r = C[0];
		var id = r.data.id;
		var url = 'com.keensen.ump.produce.quality.importDeliveryReportDetail.flow?relationId='
				+ id + '&tag=' + this.excelUploadWin.tag;
	...
	if (!A.getSelectionModel().getSelected()) {
		...
		Ext.Msg.prompt('合格证打印', '检验结论', function(btn, text) {
					if (btn == 'ok') {
						...
						var productName = r.data.productName;
						window.open(
								'com.keensen.ump.produce.quality.certificate.flow?opt=view&result='
										+ text + '&entity/id=' + id, "top");
					}
				}, this, false, '合格')
	...
	if (!A.getSelectionModel().getSelected()) {
		...
		Ext.Msg.prompt('合格证打印', '检验结论', function(btn, text) {
					if (btn == 'ok') {
						...
						var productName = r.data.productName;
						window.open(
								'com.keensen.ump.produce.quality.certificate.flow?opt=print&result='
										+ text + '&entity/id=' + id, "top");
					}
				}, this, false, '合格')
