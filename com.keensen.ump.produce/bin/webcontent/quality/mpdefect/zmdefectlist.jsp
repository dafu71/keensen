...
<%
    ...
    String dimoBatchNo = request.getParameter("dimoBatchNo");
%>
<html>
<!-- 
  - Author(s): dafu
...
<js:load scriptPath="produce/quality/mpdefect/js/zmDefectListUi.js"/>
<js:load scriptPath="produce/quality/mpdefect/js/zmDefectListEv.js"/>
...
<script type="text/javascript">
  ...
  var dimoBatchNo4Search = "<%=dimoBatchNo  %>";
  
  var opt = '';
  FunctionMgr.load({ 
			mainfn:com.keensen.ump.produce.quality.ZmDefectListMgr
		});
 </script>
</head>
<body>
<div id="zmdefectlistmgr"></div>
</body>
</html>