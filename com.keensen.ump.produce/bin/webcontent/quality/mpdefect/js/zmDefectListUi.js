com.keensen.ump.produce.quality.ZmDefectListMgr = function() {
	...
	this.initListPanel = function() {
		...
		this.listPanel = new Ext.fn.ListPanel({
			...
			store : new Ext.data.JsonStore({
				url : 'com.keensen.ump.produce.quality.defect.queryZmDefectListByPage.biz.ext',
				root : 'data',
				autoLoad : true,
