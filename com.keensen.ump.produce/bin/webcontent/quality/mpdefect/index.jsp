...
<js:load scriptPath="produce/quality/mpdefect/js/manageUi.js"/>
<js:load scriptPath="produce/quality/mpdefect/js/manageEv.js"/>
...
<script type="text/javascript">
  ...
  var opt = '';
  FunctionMgr.load({ 
			mainfn:com.keensen.ump.produce.quality.MpdefectMgr
		});
 </script>
</head>
<body>
<div id="mpdefectmgr"></div>
</body>
</html>