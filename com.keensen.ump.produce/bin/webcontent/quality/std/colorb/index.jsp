...
<js:load scriptPath="produce/quality/std/colorb/js/manageUi.js"/>
<js:load scriptPath="produce/quality/std/colorb/js/manageEv.js"/>
...
<script type="text/javascript">
  ...
  var mylistid = Ext.id();
  FunctionMgr.load({ 
			mainfn:com.keensen.ump.produce.quality.ColorbMgr
		});
 </script>
</head>
<body>
<div id="colorbmgr"></div>
</body>
</html>