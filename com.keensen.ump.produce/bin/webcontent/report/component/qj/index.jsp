...
<js:load scriptPath="produce/report/component/qj/js/manageUi.js"/>
<js:load scriptPath="produce/report/component/qj/js/manageEv.js"/>
...
function getCurrentDate(t) {
  ...
  FunctionMgr.load({ 
			mainfn:com.keensen.ump.produce.report.component.QjCountMgr
		});
...
<body>
<div id="componentreportqjcountmgr"></div>
</body>
</html>