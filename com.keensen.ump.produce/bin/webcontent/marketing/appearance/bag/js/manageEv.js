com.keensen.ump.produce.marketing.BagMgr.prototype.initEvent = function() {
	// 查询事件
...
com.keensen.ump.produce.marketing.BagMgr.prototype.onDel = function() {
	this.listPanel.onDel();
};

com.keensen.ump.produce.marketing.BagMgr.prototype.onAdd = function() {
	this.inputWindow.show();

}

com.keensen.ump.produce.marketing.BagMgr.prototype.destroy = function() {
	this.editWindow.destroy();
	this.inputWindow.destroy();
}

com.keensen.ump.produce.marketing.BagMgr.prototype.onEdit = function() {
	this.listPanel.onEdit();
};

com.keensen.ump.produce.marketing.BagMgr.prototype.onUploadWindowShow = function(
		o) {
...
// 文件上传
com.keensen.ump.produce.marketing.BagMgr.prototype.doUpload = function() {
				...
				if (result.success) {
					...
					if (myflag == '1') {
						...
						Ext.Ajax.request({
							method : "post",
							scope : this,
							url : 'com.keensen.ump.produce.marketing.appearance.saveBag.biz.ext',
							jsonData : {
								'entity/id' : pkid,
								'entity/url' : fname
							},
...
com.keensen.ump.produce.marketing.BagMgr.prototype.onModifyUrl = function() {
...
com.keensen.ump.produce.marketing.BagMgr.prototype.onChangeState = function() {
	var A = this.listPanel;
	var _this = this;
	if (!A.getSelectionModel().getSelected()) {
		Ext.Msg.alert("系统提示", "没有选定数据，请选择数据行！");
		...
		Ext.Ajax.request({
			url : "com.keensen.ump.produce.marketing.appearance.saveBatchBagState.biz.ext",
			method : "post",
			jsonData : {
				ids : ids.join(',')
...
com.keensen.ump.produce.marketing.BagMgr.prototype.exportExcel = function() {
	
	doQuerySqlAndExport(this, this.queryPanel, this.listPanel, '包装袋订制',
			'com.keensen.ump.produce.marketing.appearance.queryBag');
}