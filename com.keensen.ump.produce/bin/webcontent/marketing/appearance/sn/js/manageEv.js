com.keensen.ump.produce.marketing.SnMgr.prototype.initEvent = function() {
...
com.keensen.ump.produce.marketing.SnMgr.prototype.onCreate = function() {
...
com.keensen.ump.produce.marketing.SnMgr.prototype.onSave = function() {
	var _this = this;
...
com.keensen.ump.produce.marketing.SnMgr.prototype.exportExcel = function() {
	doQuerySqlAndExport(this, this.queryPanel, this.listPanel, '元件序列号',
			'com.keensen.ump.produce.component.sn.query');
}

com.keensen.ump.produce.marketing.SnMgr.prototype.onModify = function() {
...
com.keensen.ump.produce.marketing.SnMgr.prototype.onAdd = function() {
	// var C = this.listPanel.getSelectionModel().getSelections();
	...
	this.inputWindow.prefix.setValue('');
	this.inputWindow.prodSpecName.setValue('');
	this.inputWindow.useType.setValue('非常规');
	this.inputWindow.digit.setValue('');
	this.inputWindow.rule.setValue('');
	this.inputWindow.reserve1.setValue('');
	this.inputWindow.reserve2.setValue('');
...
com.keensen.ump.produce.marketing.SnMgr.prototype.onStop = function() {
...
com.keensen.ump.produce.marketing.SnMgr.prototype.onModifyNum = function() {
	var B = this.listPanel.getSelectionModel().getSelections();
	if (B && B.length != 0) {
		if (B.length > 1) {
			Ext.Msg.alert("系统提示", "仅允许选择一条数据行!");
...
com.keensen.ump.produce.marketing.SnMgr.prototype.getExample = function() {
...
com.keensen.ump.produce.marketing.SnMgr.prototype.exportExcel = function() {
	...
	doQuerySqlAndExport(this, this.queryPanel, this.listPanel, '序列号编码规则订制',
			'com.keensen.ump.produce.component.sn.query');
}
