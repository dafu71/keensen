 ...
 * <ul>
 *   <li>{@link com.zoomlion.hjsrm.data.org.Organization.impl.VOmEmporgImpl#getEmpid <em>Empid</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.data.org.Organization.impl.VOmEmporgImpl#getEmpcode <em>Empcode</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.data.org.Organization.impl.VOmEmporgImpl#getEmpname <em>Empname</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.data.org.Organization.impl.VOmEmporgImpl#getRealname <em>Realname</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.data.org.Organization.impl.VOmEmporgImpl#getEmpstatus <em>Empstatus</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.data.org.Organization.impl.VOmEmporgImpl#getMobileno <em>Mobileno</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.data.org.Organization.impl.VOmEmporgImpl#getOrgidlist <em>Orgidlist</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.data.org.Organization.impl.VOmEmporgImpl#getDataorgname <em>Dataorgname</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.data.org.Organization.impl.VOmEmporgImpl#getDataorgid <em>Dataorgid</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.data.org.Organization.impl.VOmEmporgImpl#getOrgid <em>Orgid</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.data.org.Organization.impl.VOmEmporgImpl#getParentorgid <em>Parentorgid</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.data.org.Organization.impl.VOmEmporgImpl#getOrgcode <em>Orgcode</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.data.org.Organization.impl.VOmEmporgImpl#getOrgname <em>Orgname</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.data.org.Organization.impl.VOmEmporgImpl#getOrglevel <em>Orglevel</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.data.org.Organization.impl.VOmEmporgImpl#getOrgdegree <em>Orgdegree</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.data.org.Organization.impl.VOmEmporgImpl#getOrgseq <em>Orgseq</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.data.org.Organization.impl.VOmEmporgImpl#getOrgtype <em>Orgtype</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.data.org.Organization.impl.VOmEmporgImpl#getUserid <em>Userid</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.data.org.Organization.impl.VOmEmporgImpl#getPassword <em>Password</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.data.org.Organization.impl.VOmEmporgImpl#getOperatorname <em>Operatorname</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.data.org.Organization.impl.VOmEmporgImpl#getStatus <em>Status</em>}</li>
 * </ul>
 * </p>
 *
 * @extends ExtendedDataObjectImpl;
 *
 * @implements VOmEmporg;
 */

public class VOmEmporgImpl extends ExtendedDataObjectImpl implements VOmEmporg {
	/**
	...
	public final static int INDEX_EMPSTATUS = 4;
	public final static int INDEX_MOBILENO = 5;
	public final static int INDEX_ORGIDLIST = 6;
	public final static int INDEX_DATAORGNAME = 7;
	public final static int INDEX_DATAORGID = 8;
	public final static int INDEX_ORGID = 9;
	public final static int INDEX_PARENTORGID = 10;
	public final static int INDEX_ORGCODE = 11;
	public final static int INDEX_ORGNAME = 12;
	public final static int INDEX_ORGLEVEL = 13;
	public final static int INDEX_ORGDEGREE = 14;
	public final static int INDEX_ORGSEQ = 15;
	public final static int INDEX_ORGTYPE = 16;
	public final static int INDEX_USERID = 17;
	public final static int INDEX_PASSWORD = 18;
	public final static int INDEX_OPERATORNAME = 19;
	public final static int INDEX_STATUS = 20;
	 ...
	 * <!-- end-user-doc -->
	 */
	public VOmEmporgImpl(Type type) {
		super(type);
	}
	...
	public String getDataorgname() {
		return DataUtil.toString(super.getByIndex(INDEX_DATAORGNAME, true));
	}

	/**
	 * Sets the value of the '{@link com.primeton.eos.Test#getDataorgname <em>Dataorgname</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public void setDataorgname(String dataorgname) {
		super.setByIndex(INDEX_DATAORGNAME, dataorgname);
	}
