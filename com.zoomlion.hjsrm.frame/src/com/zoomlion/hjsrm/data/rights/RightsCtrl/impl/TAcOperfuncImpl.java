...
import com.zoomlion.hjsrm.data.rights.RightsCtrl.TAcOperfunc;
 ...
 * <ul>
 *   <li>{@link com.zoomlion.hjsrm.data.rights.RightsCtrl.impl.TAcOperfuncImpl#getOperatorid <em>Operatorid</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.data.rights.RightsCtrl.impl.TAcOperfuncImpl#getResid <em>Resid</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.data.rights.RightsCtrl.impl.TAcOperfuncImpl#getAuthtype <em>Authtype</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.data.rights.RightsCtrl.impl.TAcOperfuncImpl#getStartdate <em>Startdate</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.data.rights.RightsCtrl.impl.TAcOperfuncImpl#getEnddate <em>Enddate</em>}</li>
 *   <li>{@link com.zoomlion.hjsrm.data.rights.RightsCtrl.impl.TAcOperfuncImpl#getDataorgid <em>Dataorgid</em>}</li>
 * </ul>
 * </p>
 *
 * @extends ExtendedDataObjectImpl;
 *
 * @implements TAcOperfunc;
 */

public class TAcOperfuncImpl extends ExtendedDataObjectImpl implements TAcOperfunc {
	/**
	 ...
	 * <!-- end-user-doc -->
	 */
	public TAcOperfuncImpl(Type type) {
		super(type);
	}
