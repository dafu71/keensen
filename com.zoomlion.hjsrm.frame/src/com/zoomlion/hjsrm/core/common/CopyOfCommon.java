 ...
 *      **************************************************
 */
public class CopyOfCommon implements Serializable {
	...
	public static IUserObject getCurrentUseObject() throws Exception {
		return CopyOfCommon.getCurrentUserObject();
	}
	...
	public static String getCurrentUserId() throws Exception {
		if (CopyOfCommon.getCurrentUserObject() == null) {
			return "guest";
		} else {
...
*/
			return CopyOfCommon.getCurrentUserObject().getUserId();
		}
		/*
		 * ISessionMap session = DataContextManager.current().getSessionCtx();
	...
	public static String getCurrentUserOrgId() throws Exception {
		if (CopyOfCommon.getCurrentUserObject() == null) {
			...
			return CopyOfCommon.getCurrentUserObject().getUserOrgId();
		}
		/*
		 * ISessionMap session = DataContextManager.current().getSessionCtx();
		 * if (session == null) {
	...
	public static String getCurrentUserAreaCode() throws Exception {
		if (CopyOfCommon.getCurrentUserObject() == null) {
			...
			return (String) CopyOfCommon.getCurrentUserObject().getAttributes().get(
					"areacode");
		}
		/*
		 * ISessionMap session = DataContextManager.current().getSessionCtx();
	...
	public static boolean isLogin() throws Exception {
		...
		String currentUniqueId = CopyOfCommon.getCurrentUserObject().getUniqueId();
		String currentUserId = CopyOfCommon.getCurrentUserObject().getUserId();
