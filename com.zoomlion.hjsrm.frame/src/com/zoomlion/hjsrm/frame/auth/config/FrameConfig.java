...
public class FrameConfig{
	...
	public  static String SRM_FRAME_CONFIG_FILENAME = "srmframe.xml";
	
	//linux下配置
	//public  static String SRM_FRAME_CONFIG_FILEPATH = "//WEB-INF//srmconfig//";	
	 ...
	 * @return String
	 */
	public static String  getFrameConfigPath() throws Exception{
		String configPath = ApplicationContext.getInstance().getWarRealPath()+SRM_FRAME_CONFIG_FILEPATH;
		return configPath;
	}
	 ...
	 * @return String
	 */
	public static String  getFrameConfigFile() throws Exception{
		String appConfigPath = getFrameConfigPath();
		String filePath = appConfigPath+SRM_FRAME_CONFIG_FILENAME;
		return filePath;
	}
	...
	public static Configuration  load() throws Exception{
		String filePath = getFrameConfigFile();
		Configuration configuration = Configuration.initConfiguration(filePath);
		SrmCache.putValue(Common.SRM_FRAMECONFIG_CACHEKEY, configuration);
		return configuration;
	}
	...
	public static Configuration  reload() throws Exception{
		SrmCache.removeKey(Common.SRM_FRAMECONFIG_CACHEKEY);
		return load();
	}
	 ...
	 * @return String
	 */
	public static String  getFrameConfigValue(String module, String group, String key) throws Exception{
		Configuration configuration = (Configuration)SrmCache.getValue(Common.SRM_FRAMECONFIG_CACHEKEY);
	 ...
	 * @return void
	 */
	public static void setFrameConfigValue(String module, String group, String key, String value) throws Exception{
		Configuration configuration = (Configuration)SrmCache.getValue(Common.SRM_FRAMECONFIG_CACHEKEY);
		//update by linfeng 2011-9-22 缓存为空时，加载一次
		if (configuration==null)
			configuration = load();
	 ...
	 * @return DataObject
	 */
	public static DataObject  getFrameConfigValueBatch(String[] params) throws Exception{
		if (params == null)
		      return null;
		    ...
		    for (int i = 0; i < len; i += 3) {
		      cfgDO.set(params[i]+"-"+params[(i + 1)]+"-"+params[(i + 2)], getFrameConfigValue(params[i], params[(i + 1)], params[(i + 2)]));
		    }
		    return cfgDO;
	}
	...
	public static List  getFrameConfigGroups(String module) throws Exception{
		Configuration configuration = (Configuration)SrmCache.getValue(Common.SRM_FRAMECONFIG_CACHEKEY);
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static Map  getFrameConfigGroup(String module, String group) throws Exception{
		Configuration configuration = (Configuration)SrmCache.getValue(Common.SRM_FRAMECONFIG_CACHEKEY);
