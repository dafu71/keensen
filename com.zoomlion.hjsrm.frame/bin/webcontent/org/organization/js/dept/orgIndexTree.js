 ...
 * 组织机构树
 * 
 * @class Frame.org.organization.OrgTree
 * @extends Ext.tree.TreePanel
 * 
 * <pre><code>
 * Examples : new Frame.org.OrgTree({
 * 			root : root,
 * 			loader : loader
 * 		});
 * </code></pre>
 */
com.zoomlion.hjsrm.org.OrgIndexTree = Ext.extend(Ext.tree.TreePanel, {
	title : '组织机构树',
	rootVisible : false,
	margin:5,
	useArrows : true,
	...
	initComponent : function() {
		...
		this.buildTools();
		this.buildTbar();
		com.zoomlion.hjsrm.org.OrgIndexTree.superclass.initComponent.call(this);
		this.on({
					scope : this,
...
Ext.reg("orgtree", com.zoomlion.hjsrm.org.OrgIndexTree);