...
<js:load scriptPath="base/appearancestd/js/manageUi.js"/>
<js:load scriptPath="base/appearancestd/js/manageEv.js"/>
<script type="text/javascript">
  var uid = "<%=uid %>";
  FunctionMgr.load({ 
			mainfn:com.keensen.ump.base.AppearancestdMgr
		});
 </script>
</head>
<body>
<div id="appearancestdmgr"></div>
</body>
</html>