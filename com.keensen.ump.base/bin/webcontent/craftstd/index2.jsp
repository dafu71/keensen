...
<js:load scriptPath="base/craftstd/js/manageUi3.js"/>
<js:load scriptPath="base/craftstd/js/manageEv3.js"/>
<script type="text/javascript">
  var uid = "<%=uid %>";
  ...
  FunctionMgr.load({ 
			mainfn:com.keensen.ump.base.CraftStdMgr
		});
 </script>
</head>
<body>
<div id="craftstdmgr"></div>
</body>
</html>