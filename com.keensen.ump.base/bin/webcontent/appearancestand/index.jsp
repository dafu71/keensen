...
<js:load scriptPath="base/appearancestand/js/manageUi.js"/>
<js:load scriptPath="base/appearancestand/js/manageEv.js"/>
<script type="text/javascript">
  var uid = "<%=uid %>";
  FunctionMgr.load({ 
			mainfn:com.keensen.ump.base.AppearancestandMgr
		});
 </script>
</head>
<body>
<div id="appearancestandmgr"></div>
</body>
</html>