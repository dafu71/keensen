...
<js:load scriptPath="base/appearancenotstd/js/manageUi.js"/>
<js:load scriptPath="base/appearancenotstd/js/manageEv.js"/>
<script type="text/javascript">
  var uid = "<%=uid %>";
  FunctionMgr.load({ 
			mainfn:com.keensen.ump.base.AppearancenotstdMgr
		});
 </script>
</head>
<body>
<div id="appearancenotstdmgr"></div>
</body>
</html>