...
<script type="text/javascript">
	BIZ.ns('com.keensen.ump.base.k3');
</script>

<js:load scriptPath="base/k3/mater/js/manageUi.js"/>
<js:load scriptPath="base/k3/mater/js/manageEv.js"/>
...
<script type="text/javascript">
  var uid = "<%=uid %>";
  FunctionMgr.load({ 
			mainfn:com.keensen.ump.base.k3.K3BomMgr
		});
 </script>
</head>
<body>
