...
<js:load scriptPath="base/craftspackage/js/manageUi.js"/>
<js:load scriptPath="base/craftspackage/js/manageEv.js"/>
<script type="text/javascript">
  var uid = "<%=uid %>";
  ...
  FunctionMgr.load({ 
			mainfn:com.keensen.ump.base.CraftspackageMgr
		});
 </script>
</head>
<body>
<div id="craftspackagemgr"></div>
</body>
</html>