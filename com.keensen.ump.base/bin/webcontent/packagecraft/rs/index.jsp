...
<js:load scriptPath="base/packagecraft/rs/js/manageUi.js"/>
<js:load scriptPath="base/packagecraft/rs/js/manageEv.js"/>
<script type="text/javascript">
  var uid = "<%=uid %>";
  ...
  FunctionMgr.load({ 
			mainfn:com.keensen.ump.base.RsCraftspackageMgr
		});
 </script>
</head>
<body>
<div id="rscraftspackagemgr"></div>
</body>
</html>