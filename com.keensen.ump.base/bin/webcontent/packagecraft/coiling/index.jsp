...
<js:load scriptPath="base/packagecraft/coiling/js/manageUi.js"/>
<js:load scriptPath="base/packagecraft/coiling/js/manageEv.js"/>
<script type="text/javascript">
  var uid = "<%=uid %>";
  ...
  FunctionMgr.load({ 
			mainfn:com.keensen.ump.base.CoinlingCraftspackageMgr
		});
 </script>
</head>
<body>
<div id="coinlingcraftspackagemgr"></div>
</body>
</html>