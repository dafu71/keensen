com.keensen.ump.base.RsCraftspackageMgr = function() {
	...
	this.initListPanel = function() {
		...
		this.listPanel = this.listPanel || new Ext.fn.ListPanel({
		 ...
		 forceFit : true
			...
			selModel : selModel,
			delUrl : 'com.keensen.ump.base.packagecraft.deleteCraftspackageRs.biz.ext',
	...
	this.initInputWindow = function() {
		...
		this.inputWindow = this.inputWindow || new Ext.fn.FormWindow({
			...
			items : [{
				...
				columns : 6,
				saveUrl : 'com.keensen.ump.base.packagecraft.addCraftspackageRs.biz.ext',
				fields : [{
							xtype : 'combo',
							fieldLabel : '状态',
							ref : '../../state',
	...
	this.initEditWindow = function() {
		...
		this.editWindow = this.editWindow || new Ext.fn.FormWindow({
			...
			items : [{
				...
				pgrid : _this.listPanel,
				columns : 6,
				saveUrl : 'com.keensen.ump.base.packagecraft.saveCraftspackageRs.biz.ext',
				loadUrl : 'com.keensen.ump.base.packagecraft.expandCraftspackageRs.biz.ext',
				fields : [{
							xtype : 'combo',
							fieldLabel : '状态',
							dataIndex : 'state',
