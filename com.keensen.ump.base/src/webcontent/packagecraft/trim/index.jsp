...
<js:load scriptPath="base/packagecraft/trim/js/manageUi.js"/>
<js:load scriptPath="base/packagecraft/trim/js/manageEv.js"/>
<script type="text/javascript">
  var uid = "<%=uid %>";
  ...
  FunctionMgr.load({ 
			mainfn:com.keensen.ump.base.TrimCraftspackageMgr
		});
 </script>
</head>
<body>
<div id="trimcraftspackagemgr"></div>
</body>
</html>