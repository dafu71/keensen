Ext.namespace('com.keensen.ump.base');
/**
 * 树节点加载组件
 * @class Frame.org.organization.OrgTreeLoader
 * @extends Ext.tree.TreeLoader
 */
com.keensen.ump.base.MaterSingleLoader = Ext.extend(Ext.tree.TreeLoader, {
	isASyncTree:false,
	//dataUrl : 'com.zoomlion.hjsrm.frame.org.organization.OrgManager.getOrganizationTree.biz.ext',
	dataUrl : 'com.keensen.ump.base.mater.queryMaterClassTree.biz.ext',
	constructor : function(config) {
		com.keensen.ump.base.MaterSingleLoader.superclass.constructor.call(this,
				config);
			this.on({
					scope : this,
			...
			if(this.isASyncTree){//是否同步树
				Ext.each(_collections.data, function(org) {// 机构节点数组
						var baseParams = {
							...
							text : org.orgname,
							leaf : false,
							iconCls : org.upId==0?'icon-folder_home':'icon-folder_user',
							type : 'org'
						}
...
Ext.reg("matersingleloader", com.keensen.ump.base.MaterSingleLoader);
