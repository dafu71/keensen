 ...
 * 物料树
 * 
 * @class com.keensen.ump.base.MaterIndexTree
 * @extends Ext.tree.TreePanel
 * 
 * <pre><code>
 * Examples : new com.keensen.ump.base.MaterIndexTree({
 * 			root : root,
 * 			loader : loader
 * 		});
 * </code></pre>
 */
com.keensen.ump.base.MaterIndexTree = Ext.extend(Ext.tree.TreePanel, {
	title : '物料树',
	rootVisible : false,
	margin:5,
	useArrows : true,
	...
	initComponent : function() {
		...
		this.buildTools();
		this.buildTbar();
		com.keensen.ump.base.MaterIndexTree.superclass.initComponent.call(this);
		this.on({
					scope : this,
...
Ext.reg("materindextree", com.keensen.ump.base.MaterIndexTree);