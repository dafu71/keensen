com.zoomlion.hjsrm.techNotice.GuidangMgr.prototype.destroy = function() {
	this.editPanel.destroy();
	this.initListActionPanel.destroy();	
}

com.zoomlion.hjsrm.techNotice.GuidangMgr.prototype.initEvent = function() {
...
com.zoomlion.hjsrm.techNotice.GuidangMgr.prototype.onSave = function() {
	...
	Ext.Ajax.request({
				method : "post",
				scope : this,
				url : 'com.zoomlion.hjsrm.techNotice.noticeMgr.guidangTechNotice.biz.ext',
				jsonData : {					
					techNotices:forms					
				},
 ...
 * 回退窗口关闭
 */
com.zoomlion.hjsrm.techNotice.GuidangMgr.prototype.onBackClose= function() {		
 ...
 * 回退窗口，选择需要回退的环节
 */
com.zoomlion.hjsrm.techNotice.GuidangMgr.prototype.onBackItem = function() {	
 ...
 * 回退窗口提交
 */
com.zoomlion.hjsrm.techNotice.GuidangMgr.prototype.onBack= function() {
	var _this=this;
...
com.zoomlion.hjsrm.techNotice.GuidangMgr.prototype.onClose = function() {
	closeMyTab();
}
