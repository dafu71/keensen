...
<js:load scriptPath="techNotice/feedback/js/feedbackUi.js"/>
<js:load scriptPath="techNotice/feedback/js/feedbackEv.js"/>
...
<script type="text/javascript">
   ...
   FunctionMgr.load({ 
			mainfn:com.zoomlion.hjsrm.techNotice.FeedBackMgr
		});

 </script>
</head>
<body>
<div id="feedbackMgr"></div>
</body>
</html>