com.zoomlion.hjsrm.techNotice.AuditingMgr.prototype.destroy = function() {
...
com.zoomlion.hjsrm.techNotice.AuditingMgr.prototype.initEvent = function() {
	...
	this.storePerson.baseParams = {"roleid" : "106"};									
 ...
 * 移除角色操作员方法
 */
com.zoomlion.hjsrm.techNotice.AuditingMgr.prototype.onDelOperator = function() {
...
com.zoomlion.hjsrm.techNotice.AuditingMgr.prototype.onSave = function() {
	...
	Ext.Ajax.request({
				method : "post",
				scope : this,
				url : 'com.zoomlion.hjsrm.techNotice.noticeMgr.auditingTechNotice.biz.ext',
				jsonData : {
					persons : vals,
					techNotices:forms					
				},
 ...
 * 回退窗口关闭
 */
com.zoomlion.hjsrm.techNotice.AuditingMgr.prototype.onBackClose= function() {
 ...
 * 回退窗口，选择需要回退的环节
 */
com.zoomlion.hjsrm.techNotice.AuditingMgr.prototype.onBackItem = function() {	
 ...
 * 回退窗口提交
 */
com.zoomlion.hjsrm.techNotice.AuditingMgr.prototype.onBack= function() {
	var _this=this;
...
com.zoomlion.hjsrm.techNotice.AuditingMgr.prototype.onClose = function() {
	closeMyTab();
}
