...
<js:load scriptPath="techNotice/confirm/js/confirmUi.js"/>
<js:load scriptPath="techNotice/confirm/js/confirmEv.js"/>
...
<script type="text/javascript">
   ...
   FunctionMgr.load({ 
			mainfn:com.zoomlion.hjsrm.techNotice.ConfirmMgr
		});

 </script>
</head>
<body>
<div id="confirmMgr"></div>
</body>
</html>