 ...
 * 销毁组件
 */
com.zoomlion.hjsrm.techNotice.NextsMgr.prototype.destroy = function() {
 ...
 * 初始化组件事件
 */
com.zoomlion.hjsrm.techNotice.NextsMgr.prototype.initEvent = function() {
 ...
 * 选择人员信息
 */
com.zoomlion.hjsrm.techNotice.NextsMgr.prototype.onSelect = function() {
 ...
 * 移除操作员方法
 */
com.zoomlion.hjsrm.techNotice.NextsMgr.prototype.onDelOperator = function() {
 ...
 * @return {Boolean}
 */
com.zoomlion.hjsrm.techNotice.NextsMgr.prototype.onSave = function() {
 ...
 * 回退窗口关闭
 */
com.zoomlion.hjsrm.techNotice.NextsMgr.prototype.onBackClose = function() {
 ...
 * 回退窗口，选择需要回退的环节
 */
com.zoomlion.hjsrm.techNotice.NextsMgr.prototype.onBackItem = function() {
 ...
 * 回退窗口提交
 */
com.zoomlion.hjsrm.techNotice.NextsMgr.prototype.onBack = function() {
	var _this = this;
 ...
 * 流程处理TAB页关闭
 */
com.zoomlion.hjsrm.techNotice.NextsMgr.prototype.onClose = function() {
	closeMyTab();
}
 ...
 * 采购反馈参与人员选择
 */
com.zoomlion.hjsrm.techNotice.NextsMgr.prototype.onSelectPart = function() {
	var _this = this;
	var store = _this.listPartPanel.store;
	var readerWindow = readerWindow || new com.zoomlion.hjsrm.selectParticipantsWindow({
				title : '选择采购反馈参与人员',
				partTitle : '采购反馈参与人员',
				divisionFront : "|",
				divisionBack : ',',
 ...
 * 移除操作员
 */
com.zoomlion.hjsrm.techNotice.NextsMgr.prototype.onDelPart = function() {
