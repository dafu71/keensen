...
//归档角色
var CURRENTROLEID2 = '104';
var CURRENTROLECODE2 = '00164';
 </script>
 <js:load scriptPath="techNotice/purchases/js/purchaseUi.js"/>
<js:load scriptPath="techNotice/purchases/js/purchaseEv.js"/>
...
<script type="text/javascript">
   ...
   FunctionMgr.load({ 
			mainfn:com.zoomlion.hjsrm.techNotice.PurchaseMgr
		});

 </script>
</head>
<body>
<div id="purchaseMgr"></div>
</body>
</html>