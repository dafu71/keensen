 ...
 * 销毁组件
 */
com.zoomlion.hjsrm.techNotice.PurchaseMgr.prototype.destroy = function() {
 ...
 * 初始化组件事件
 */
com.zoomlion.hjsrm.techNotice.PurchaseMgr.prototype.initEvent = function() {
 ...
 * 加载所有供应商
 */
com.zoomlion.hjsrm.techNotice.PurchaseMgr.prototype.onLoadAll = function() {
 ...
 * 选择人员信息
 */
com.zoomlion.hjsrm.techNotice.PurchaseMgr.prototype.onSelect = function() {
...
com.zoomlion.hjsrm.techNotice.PurchaseMgr.prototype.onSelectArchives = function() {
	// this.listEmpPanel.fireEvent("select");
	var _this = this;
 ...
 * 移除操作员方法
 */
com.zoomlion.hjsrm.techNotice.PurchaseMgr.prototype.onDelOperator = function() {
 ...
 * 移除归档操作员方法
 */
com.zoomlion.hjsrm.techNotice.PurchaseMgr.prototype.onDelArchives = function() {
 ...
 * @return {Boolean}
 */
com.zoomlion.hjsrm.techNotice.PurchaseMgr.prototype.onSave = function() {
 ...
 * 回退窗口关闭
 */
com.zoomlion.hjsrm.techNotice.PurchaseMgr.prototype.onBackClose = function() {
 ...
 * 回退窗口，选择需要回退的环节
 */
com.zoomlion.hjsrm.techNotice.PurchaseMgr.prototype.onBackItem = function() {
 ...
 * 回退窗口提交
 */
com.zoomlion.hjsrm.techNotice.PurchaseMgr.prototype.onBack = function() {
	var _this = this;
 ...
 * 流程处理TAB页关闭
 */
com.zoomlion.hjsrm.techNotice.PurchaseMgr.prototype.onClose = function() {
	closeMyTab();
}
