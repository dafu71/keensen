...
// 
// =================================================================
com.zoomlion.hjsrm.techNotice.PurchaseMgr = function() {
	...
	this.initEditPanel = function() {
		...
		this.editPanel = new Ext.fn.EditPanel({
			...
			fields : [{
					...
					/*
					 * { xtype : 'dictcheckboxgroup', style :
					 * 'padding-top:3px;padding-left:10px;', name : "nextItems",
					 * fieldLabel : '处理结果', dictData : TECH_NOTICES_ACTION,
					 * colspan : 2, anchor : '40%', allowBlank : false }
					 */
					{
						xtype : 'radiogroup',
						ref : '../nextItems',
